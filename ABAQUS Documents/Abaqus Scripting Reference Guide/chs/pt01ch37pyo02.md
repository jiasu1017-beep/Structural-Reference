...
### 37.2.3 AnalyticRigidSurf2DPlanar(...)

This method creates a first Feature object for an analytical rigid surface by creating a planar wire from the given [ConstrainedSketch](pt01ch48pyo01.md) object.
...
A [ConstrainedSketch](pt01ch48pyo01.md) object specifying the planar wire.
...
### 37.2.4 AnalyticRigidSurfExtrude(...)

This method creates a first Feature object for an analytical rigid surface by extruding the given [ConstrainedSketch](pt01ch48pyo01.md) object by the given depth, creating a surface.
...
### 37.2.5 AnalyticRigidSurfRevolve(...)

This method creates a first Feature object for an analytical rigid surface by revolving the given [ConstrainedSketch](pt01ch48pyo01.md) object by 360 about the *Y*-axis.
...
A [ConstrainedSketch](pt01ch48pyo01.md) object specifying the surface to be revolved.
...
### 37.2.6 AssignMidsurfaceRegion(...)

This method assign a mid-surface property to sequence of [Cell](pt01ch07pyo01.md) objects. If a reference representation of the part does not exist, it creates one. It also copies the *cells* to the reference representation and deletes the *cells* from the active representation of the part.
...
A sequence of [Cell](pt01ch07pyo01.md) objects specifying the regions that will be used for mid-surface construction. These regions will be copied to the reference representation of the part.
...
### 37.2.7 BaseSolidExtrude(...)

This method creates a first Feature object by extruding the given [ConstrainedSketch](pt01ch48pyo01.md) object by the given depth, creating a solid. The [ConstrainedSketch](pt01ch48pyo01.md) object must define a closed profile.
...
A [ConstrainedSketch](pt01ch48pyo01.md) object specifying the plane shape to be extruded.

*depth*

A Float specifying the extrusion depth. Possible values are 10–5 ![](../graphics/ker_eqn00013.gif) *depth* ![](../graphics/ker_eqn00013.gif) 105.
...
### 37.2.8 BaseSolidRevolve(...)

This method creates a first Feature object by revolving the given [ConstrainedSketch](pt01ch48pyo01.md) object by the given angle, creating a solid. The [ConstrainedSketch](pt01ch48pyo01.md) object must define a closed profile and an axis of revolution. The axis is defined by a single construction line.
...
A [ConstrainedSketch](pt01ch48pyo01.md) object specifying the shape to be revolved.

*angle*

A Float specifying the revolve angle in degrees. Possible values are 10–4 ![](../graphics/ker_eqn00013.gif) *angle* ![](../graphics/ker_eqn00013.gif) 360.

**Note:**If *pitch* ![](../graphics/ker_eqn00060.gif)0, there is no upper limit for *angle*.

**Optional arguments**

*pitch*

A Float specifying the pitch. The pitch is the distance traveled along the axial direction, measured between corresponding points on the sketch when it has completed one full revolution about the axis of revolution. Possible values are 0 ![](../graphics/ker_eqn00013.gif) *pitch* ![](../graphics/ker_eqn00013.gif) 105. The default value, 0, implies a normal revolve.
...
### 37.2.9 BaseSolidSweep(...)

This method creates a first Feature object by sweeping the given profile [ConstrainedSketch](pt01ch48pyo01.md) object along the path defined by the path [ConstrainedSketch](pt01ch48pyo01.md) object, creating a solid. The profile [ConstrainedSketch](pt01ch48pyo01.md) object must define a closed profile. The origin of the profile sketch is positioned at the start of the sweep path and swept perpendicular to the path. No checks are made for self-intersection.
...
A [ConstrainedSketch](pt01ch48pyo01.md) object specifying the profile to be swept.

*path*

A [ConstrainedSketch](pt01ch48pyo01.md) object specifying the path of the sweep.
...
This method creates a first Feature object by creating a planar shell from the given [ConstrainedSketch](pt01ch48pyo01.md) object. The [ConstrainedSketch](pt01ch48pyo01.md) object must define a closed profile.
...
A [ConstrainedSketch](pt01ch48pyo01.md) object specifying the planar shell.
...
### 37.2.11 BaseShellExtrude(...)

This method creates a first Feature object by extruding the given [ConstrainedSketch](pt01ch48pyo01.md) object by the given depth, creating a shell. The [ConstrainedSketch](pt01ch48pyo01.md) object can define either an open or closed profile.
...
A [ConstrainedSketch](pt01ch48pyo01.md) object specifying the shape to be extruded.
...
### 37.2.12 BaseShellRevolve(...)

This method creates a first Feature object by revolving the given [ConstrainedSketch](pt01ch48pyo01.md) object by the given angle, creating a shell. The [ConstrainedSketch](pt01ch48pyo01.md) object can define either an open or closed profile and an axis of revolution. The axis is defined by a single construction line.
...
A Float specifying the revolve angle in degrees. Possible values are 0 ![](../graphics/ker_eqn00013.gif) *angle* ![](../graphics/ker_eqn00013.gif) 360.
...
### 37.2.13 BaseShellSweep(...)

This method creates a first Feature object by sweeping the given section [ConstrainedSketch](pt01ch48pyo01.md) object along the path defined by the path [ConstrainedSketch](pt01ch48pyo01.md) object, creating a shell. The [ConstrainedSketch](pt01ch48pyo01.md) object can define either an open or closed profile. The origin of the profile sketch is positioned at the start of the sweep path and swept perpendicular to the path. No checks are made for self-intersection.
...
A [ConstrainedSketch](pt01ch48pyo01.md) object specifying the section to be swept.
...
This method creates a first Feature object by creating a planar wire from the given [ConstrainedSketch](pt01ch48pyo01.md) object.
...
A sequence of [Edge](pt01ch07pyo03.md) objects specifying one side of the blend. The edges must form a continuous chain without branches.

*side2*

A sequence of [Edge](pt01ch07pyo03.md) or [Face](pt01ch07pyo05.md) objects specifying the second side of the blend. If *side2* contains Edge objects then they must form a continuous chain without branches.

**Optional arguments**

*method*

A SymbolicConstant indicating a method for creating blends. This argument is a required argument if *side2* contains [Edge](pt01ch07pyo03.md) object and it is ignored if *side2* contains [Face](pt01ch07pyo05.md)objects. It can have one of the following values:
...
A [Datum](pt01ch15pyo01.md) plane object or a planar [Face](pt01ch07pyo05.md) object.
...
This method creates an additional Feature object by cutting a hole using the given [ConstrainedSketch](pt01ch48pyo01.md) object.
...
A [ConstrainedSketch](pt01ch48pyo01.md) object specifying the planar cut.
...
This method creates an additional Feature object by extruding the given [ConstrainedSketch](pt01ch48pyo01.md) object by the given depth and cutting away material in the solid and shell regions of the part. The [ConstrainedSketch](pt01ch48pyo01.md) object must define a closed profile. The `CutExtrude` method creates a blind cut (using *depth*), an up-to-face cut (using *upToFace*), or a through-all cut (if *depth* and *upToFace* are not specified).
...
A [ConstrainedSketch](pt01ch48pyo01.md) object specifying the planar sketch to be extruded.
...
This method creates an additional Feature object by lofting between the given sections and cutting away material from the part. You define the sections using a sequence of edges from the part or an [EdgeArray](pt01ch07pyo03.md).
...
A sequence of sequences of edges specifying the cross-sections to be lofted. Each outer sequence specifies a section through which the method will pass the loft feature. Each outer sequence can be defined as a sequence of edges or as an [EdgeArray](pt01ch07pyo03.md). The edges specifying a section must form a simple closed profile and must not contain multiple loops.
...
A Float specifying the angle in degrees of the tangent with respect to the plane in which the start section lies. You must specify the *startTangent* argument if *startCondition*=SPECIFIED. Possible values are 0.0 ![](../graphics/ker_eqn00013.gif) *startTangent* ![](../graphics/ker_eqn00013.gif) 180.0.

*startMagnitude*

A Float specifying the magnitude of the *startTangent*. You must specify the *startMagnitude* argument if *startCondition*=SPECIFIED.  Possible values are 0.0 ![](../graphics/ker_eqn00048.gif) *startMagnitude* ![](../graphics/ker_eqn00048.gif) 100.0.

*endTangent*

A Float specifying the angle in degrees of the tangent with respect to the plane in which the end section lies. You must specify the *endTangent* argument if *startCondition*=SPECIFIED. Possible values are 0.0 ![](../graphics/ker_eqn00013.gif) *endTangent* ![](../graphics/ker_eqn00013.gif) 180.0.

*endMagnitude*

A Float specifying the magnitude of the *endTangent*. This argument is to be used when the *endCondition* argument has the value SPECIFIED. Possible values are 0.0 ![](../graphics/ker_eqn00048.gif) *endMagnitude* ![](../graphics/ker_eqn00048.gif) 100.0.
...
This method creates an additional Feature object by revolving the given [ConstrainedSketch](pt01ch48pyo01.md) object by the given angle and cutting away material from the part. The [ConstrainedSketch](pt01ch48pyo01.md) object must define a closed profile and an axis of revolution.
...
A [ConstrainedSketch](pt01ch48pyo01.md) object specifying the planar sketch to be revolved.
...
This method creates an additional Feature object by sweeping the given [ConstrainedSketch](pt01ch48pyo01.md) object along a path which may be a [ConstrainedSketch](pt01ch48pyo01.md) or a sequence of [Edge](pt01ch07pyo03.md) objects and cutting away material from the part. If the profile section is a [ConstrainedSketch](pt01ch48pyo01.md) object, it must define a closed profile. The section sketch can be created at the normal plane at the start of the sweep path or it may be created on a [Datum](pt01ch15pyo01.md) plane or a planar [Face](pt01ch07pyo05.md). No checks are made for self-intersection.
...
### 37.2.36 RemoveRedundantEntities(...)
...
This method creates an additional Feature object by creating a planar shell from the given [ConstrainedSketch](pt01ch48pyo01.md) object. The [ConstrainedSketch](pt01ch48pyo01.md) object must define a closed profile.
...
### 37.2.45 ShellExtrude(...)

This method creates an additional Feature object by extruding the given [ConstrainedSketch](pt01ch48pyo01.md) object by the given depth, creating a shell protrusion. The [ConstrainedSketch](pt01ch48pyo01.md) object can define either an open or closed profile.
...
This method creates an additional Feature object by lofting between the given sections and adding shell faces to the part. You define the sections using a sequence of edges from the part or an [EdgeArray](pt01ch07pyo03.md).
...
### 37.2.47 ShellRevolve(...)

This method creates an additional Feature object by revolving the given [ConstrainedSketch](pt01ch48pyo01.md) object by the given angle, creating a shell protrusion. The [ConstrainedSketch](pt01ch48pyo01.md) object can define either an open or closed profile and an axis of revolution. The axis is defined by a single construction line. For a description of the plane positioning arguments, see `SolidExtrude`.
...
This method creates an additional Feature object by sweeping the given [ConstrainedSketch](pt01ch48pyo01.md) object or a sequence of [Edge](pt01ch07pyo03.md) objects along a path which may be a [ConstrainedSketch](pt01ch48pyo01.md) or a sequence of [Edge](pt01ch07pyo03.md) objects, creating a shell swept protrusion. The section can be an open or a closed profile. The section sketch can be created at the normal plane at the start of the sweep path or it may be created on a [Datum](pt01ch15pyo01.md) plane or a planar [Face](pt01ch07pyo05.md). No checks are made for self-intersection.
...
### 37.2.49 SolidExtrude(...)

This method creates an additional Feature object by extruding the given [ConstrainedSketch](pt01ch48pyo01.md) object by the given depth, creating a solid protrusion. The [ConstrainedSketch](pt01ch48pyo01.md) object must define a closed profile.
...
This method creates an additional Feature object by lofting between the given sections and adding material to the part. You define the sections using a sequence of edges from the part or an [EdgeArray](pt01ch07pyo03.md).
...
A sequence of sequences of edges specifying the cross-sections to be lofted. Each outer sequence specifies a section through which Abaqus will pass the loft feature. Each outer sequence can be defined as a sequence of edges or as an [EdgeArray](pt01ch07pyo03.md). The edges specifying a section must form a simple closed profile and must not contain multiple loops.
...
### 37.2.51 SolidRevolve(...)

This method creates an additional Feature object by revolving the given [ConstrainedSketch](pt01ch48pyo01.md) object by the given angle, creating a solid protrusion. The [ConstrainedSketch](pt01ch48pyo01.md) object must define a closed profile and an axis of revolution. The axis is defined by a single construction line.
...
This method creates an additional Feature object by creating a planar wire from the given [ConstrainedSketch](pt01ch48pyo01.md) object. The [ConstrainedSketch](pt01ch48pyo01.md) object must define a closed profile.
...
A [Datum](pt01ch15pyo01.md) plane object or a planar [Face](pt01ch07pyo05.md) object specifying the plane on which to sketch.
...
### 37.2.57 WireFromEdge(...)

This method creates an additional Feature object by creating a Wire by selecting one or more [Edge](pt01ch07pyo03.md) objects of a Solid or Shell part.
