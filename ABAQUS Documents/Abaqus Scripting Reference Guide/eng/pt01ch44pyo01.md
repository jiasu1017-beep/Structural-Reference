...
A [Set](pt01ch45pyo04.md) object specifying the region to which the section is assigned.
...
The optional arguments to `setValues` are the same as the arguments to the [SectionAssignment](pt01ch44pyo01.md#ker-sectionassignment-sectionassignment-pyc) method.
...
The SectionAssignment object has members with the same names and descriptions as the arguments to the [SectionAssignment](pt01ch44pyo01.md#ker-sectionassignment-sectionassignment-pyc) method.
