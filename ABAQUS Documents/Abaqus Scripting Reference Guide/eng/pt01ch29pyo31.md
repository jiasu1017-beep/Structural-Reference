...
If *type*=ENERGY, *softening*=LINEAR and constructor for [DamageInitiation](pt01ch29pyo32.md)=`HashinDamageInitiation` the table data specify the following:- Fiber tensile fracture energy.
...
The optional arguments to `setValues` are the same as the arguments to the [DamageEvolution](pt01ch29pyo31.md#ker-damageevolution-damageevolution-pyc) method.
...
The DamageEvolution object has members with the same names and descriptions as the arguments to the [DamageEvolution](pt01ch29pyo31.md#ker-damageevolution-damageevolution-pyc) method.
