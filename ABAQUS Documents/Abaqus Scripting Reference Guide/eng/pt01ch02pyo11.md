...
The SymbolicConstant MODEL or a [Region](pt01ch45pyo03.md) object specifying the region in which Abaqus will remesh and generate output. The SymbolicConstant MODEL represents the entire applicable model. The default value is MODEL.
...
The optional arguments to `setValues` are the same as the arguments to the [RemeshingRule](pt01ch02pyo11.md#ker-remeshingrule-remeshingrule-pyc) method, except for the *name* argument.
...
The RemeshingRule object has members with the same names and descriptions as the arguments to the [RemeshingRule](pt01ch02pyo11.md#ker-remeshingrule-remeshingrule-pyc) method.
