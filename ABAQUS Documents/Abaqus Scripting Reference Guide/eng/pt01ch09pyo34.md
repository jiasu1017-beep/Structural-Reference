...
The MaterialFlowBC object is derived from the [BoundaryCondition](pt01ch09pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [MaterialFlowBC](pt01ch09pyo34.md#ker-materialflowbc-materialflowbc-pyc) method, except for the *name* and *createStepName* arguments.
