...
![](../graphics/stm_eqn05962.gif)![](../graphics/stm_eqn05955.gif)超弹性多项式形式可以由Abaqus拟合到阶![](../graphics/stm_eqn05962)。由于Mooney-Rivlin势对应于情况![](../graphics/stm_eqn05955)，这些说明也适用于通过将更高阶系数设为零来设置。能量势如下：

![](../graphics/stm_eqn06839.gif)![](../graphics/stm_eqn06839)

![](../graphics/stm_eqn05962.gif)变形模式以主伸长来表征。现在为多项式形式推导名义应力-应变关系，![](../graphics/stm_eqn05962)。
### 单轴模式
...
![](../graphics/stm_eqn06846.gif)![](../graphics/stm_eqn06845)从虚功

![](../graphics/stm_eqn06847.gif)![](../graphics/stm_eqn06846)由此可得
...
![](../graphics/stm_eqn06855.gif)![](../graphics/stm_eqn06853)由此可得
...
![](../graphics/stm_eqn06857.gif)超弹性减缩多项式形式可以由Abaqus拟合到阶![](../graphics/stm_eqn06856)。对于![](../graphics/stm_eqn06792)，减缩多项式与Yeoh模型相同，对于![](../graphics/stm_eqn05955)，保留了neo-Hookean模型；因此，以下也适用于这些形式。减缩多项式能量势如下：

![](../graphics/stm_eqn06858.gif)![](../graphics/stm_eqn06786)遵循上一节中的论证，我们为减缩多项式推导名义应力-应变关系。
### 单轴模式
...
![](../graphics/stm_eqn06864.gif)超弹性Ogden形式可以拟合到阶![](../graphics/stm_eqn06856)：

![](../graphics/stm_eqn06865.gif)![](../graphics/stm_eqn06861)遵循与多项式形式相同的方法，我们可以推导Ogden形式的名义应力-应变方程。
### 单轴模式
...
![](../graphics/stm_eqn06848.gif)![](../graphics/stm_eqn06867)其中

![](../graphics/stm_eqn06871.gif)![](../graphics/stm_eqn06868)遵循与多项式形式相同的方法，我们可以推导Arruda-Boyce势的名义应力-应变方程。
### 单轴模式
![](../graphics/stm_eqn06852.gif)
![](../graphics/stm_eqn06857)
...
![](../graphics/stm_eqn06876.gif)![](../graphics/stm_eqn06873)其中
...
![](../graphics/stm_eqn06891.gif)![](../graphics/stm_eqn06887.gif)![](../graphics/stm_eqn01256.gif)超泡沫势是Hill应变能势的修正形式，可以拟合到阶![](../graphics/stm_eqn06856)：

![](../graphics/stm_eqn06892.gif)![](../graphics/stm_eqn06893.gif)![](../graphics/stm_eqn06878)

![](../graphics/stm_eqn06894.gif)变形模式以主伸长和体积比*J*来表征。弹性体泡沫是不可压缩的：![](../graphics/stm_eqn06879)。横向伸长![](../graphics/stm_eqn06880)和/或![](../graphics/stm_eqn06881)在测试数据中独立指定为单个值，取决于横向变形或通过有效泊松比的定义。
### 单轴模式
...
![](../graphics/stm_eqn06898.gif)![](../graphics/stm_eqn06899.gif)![](../graphics/stm_eqn06900.gif)![](../graphics/stm_eqn06885)其中![](../graphics/stm_eqn06886是名义应力，![](../graphics/stm_eqn06887)是加载方向的伸长。
### 简单剪切模式
![](../graphics/stm_eqn06773.gif)
简单剪切变形用变形梯度描述，

![](../graphics/stm_eqn06901.gif)![](../graphics/stm_eqn06888)其中![](../graphics/stm_eqn01256)是剪切应变。还要注意对于这个变形，![](../graphics/stm_eqn06889)。名义剪切应力![](../graphics/stm_eqn06890)是

![](../graphics/stm_eqn06902.gif)![](../graphics/stm_eqn06903.gif)![](../graphics/stm_eqn05955.gif)![](../graphics/stm_eqn05962.gif)![](../graphics/stm_eqn06891)其中![](../graphics/stm_eqn06887)是剪切平面中的主伸长，与剪切应变![](../graphics/stm_eqn01256)关系如下：

![](../graphics/stm_eqn06904.gif)![](../graphics/stm_eqn06905.gif)![](../graphics/stm_eqn06892)垂直于剪切平面的方向的伸长为![](../graphics/stm_eqn06893)。

![](../graphics/stm_eqn06906.gif)![](../graphics/stm_eqn06773.gif)简单剪切变形过程中产生的横向应力![](../graphics/stm_eqn06894)（作为Poynting效应的结果）是
...
![](../graphics/stm_eqn06914.gif)![](../graphics/stm_eqn06915.gif)![](../graphics/stm_eqn06916.gif)![](../graphics/stm_eqn06917.gif)![](../graphics/stm_eqn06918.gif)
...
![](../graphics/stm_eqn06925.gif)![](../graphics/stm_eqn06909)由用户给出。这个方程组可以容易地求解![](../graphics/stm_eqn06774)。
### 减缩多项式模型的线性最小二乘拟合
![](../graphics/stm_eqn06926.gif)
对于减缩多项式模型，我们可以将上面推导的![](../graphics/stm_eqn06901表达式重写为

![](../graphics/stm_eqn01087.gif)![](../graphics/stm_eqn06791.gif)![](../graphics/stm_eqn06927.gif)![](../graphics/stm_eqn06928.gif)![](../graphics/stm_eqn06929.gif)![](../graphics/stm_eqn06910)其中函数![](../graphics/stm_eqn06911)再次依赖于应力状态和伸长，如上所述，*N*是减缩多项式的阶数，可以取直到![](../graphics/stm_eqn06856)的值。以下也适用于Yeoh和neo-Hookean形式，因为这些模型是减缩多项式的特例，![](../graphics/stm_eqn06792)和![](../graphics/stm_eqn05955)分别为。

遵循与完整多项式相同的论证，我们得到*N*个方程组

![](../graphics/stm_eqn06930.gif)![](../graphics/stm_eqn06912)这个方程组可以容易地求解系数![](../graphics/stm_eqn06913)。体积系数使用与通用多项式模型相同的程序拟合。
### 非线性最小二乘拟合
...
![](../graphics/stm_eqn01087.gif)![](../graphics/stm_eqn06791.gif)![](../graphics/stm_eqn01219.gif)![](../graphics/stm_eqn06932.gif)![](../graphics/stm_eqn06928.gif)![](../graphics/stm_eqn06919)其中*r*是迭代计数，*n*是数据点数量，

![](../graphics/stm_eqn06933.gif)![](../graphics/stm_eqn06934.gif)![](../graphics/stm_eqn06929.gif)![](../graphics/stm_eqn06920)是相对误差向量，

![](../graphics/stm_eqn06921)是相对误差向量关于系数![](../graphics/stm_eqn06914)的导数。

![](../graphics/stm_eqn06935.gif)对于![](../graphics/stm_eqn02157)，获得Newton算法；对于非常小的值![](../graphics/stm_eqn01256)，获得最速下降法。因此，Marquard-Levenberg算法代表了这两种方法之间的折衷：如果误差增大则增加![](../graphics/stm_eqn06922)的值，否则减少。
### Ogden模型的非线性最小二乘拟合
...
![](../graphics/stm_eqn06940.gif)Arruda-Boyce模型关于剪切模量![](../graphics/stm_eqn01087)是线性的，但关于锁定伸长![](../graphics/stm_eqn06791)是非线性的。锁定伸长初始化为![](../graphics/stm_eqn06927)，其中![](../graphics/stm_eqn06928)是用户指定测试数据中的最大伸长。给定这个锁定伸长，初始剪切模量![](../graphics/stm_eqn06929)用线性最小二乘拟合获得。
...
![](../graphics/stm_eqn06944.gif)Van der Waals模型关于剪切模量![](../graphics/stm_eqn01087)是线性的，但关于锁定伸长![](../graphics/stm_eqn06791)、全局交互参数*a*和混合参数![](../graphics/stm_eqn01219)是非线性的。锁定伸长初始化为![](../graphics/stm_eqn06932)，其中![](../graphics/stm_eqn06928)是用户指定测试数据中的最大伸长。给定锁定伸长的这个猜测，我们利用[Kilian等（1986）](07s01a01-References.md)提出的表达式来初始化全局交互参数

![](../graphics/stm_eqn06945.gif)![](../graphics/stm_eqn06933)不变量混合参数初始化为![](../graphics/stm_eqn06934)。给定这些初始值，剪切模量![](../graphics/stm_eqn06929)使用线性最小二乘拟合程序初始化。
...
![](../graphics/stm_eqn06951.gif)在![](../graphics/stm_eqn06939)的导数中

![](../graphics/stm_eqn06952.gif)![](../graphics/stm_eqn06940)和

![](../graphics/stm_eqn06941)

![](../graphics/stm_eqn06953.gif)在平面情况下![](../graphics/stm_eqn06942)；因此，![](../graphics/stm_eqn06939)消失。
### Drucker稳定性检查
...
![](../graphics/stm_eqn06961.gif)对于两个超弹性模型，假定不可压缩，Kirchhoff应力等于Cauchy应力：![](../graphics/stm_eqn06948)，因此

![](../graphics/stm_eqn06962.gif)![](../graphics/stm_eqn06949)此外，我们可以为静水压力选择任何值而不影响应变。对于稳定性计算，一个方便的选择是![](../graphics/stm_eqn06950)，这给出我们

![](../graphics/stm_eqn06963.gif)![](../graphics/stm_eqn00424.gif)![](../graphics/stm_eqn06951)无穷小应变变化通过以下方程与伸长率的变化相关

![](../graphics/stm_eqn06964.gif)![](../graphics/stm_eqn06952)应力来自应变能，而应变能又来自应变不变量或伸长的变化。

![](../graphics/stm_eqn01087.gif)![](../graphics/stm_eqn06791.gif)应力变化和应变变化之间的关系由矩阵方程描述

![](../graphics/stm_eqn06965.gif)![](../graphics/stm_eqn01087.gif)![](../graphics/stm_eqn06791.gif)![](../graphics/stm_eqn06953)其中
...
![](../graphics/stm_eqn06968.gif)![](../graphics/stm_eqn06969.gif)![](../graphics/stm_eqn06970.gif)对于材料稳定性，![](../graphics/stm_eqn00424)必须是正定的；因此有必要

![](../graphics/stm_eqn06971.gif)![](../graphics/stm_eqn00335.gif)![](../graphics/stm_eqn00424.gif)![](../graphics/stm_eqn06957)

![](../graphics/stm_eqn06972.gif)![](../graphics/stm_eqn06958)对于所有相关的![](../graphics/stm_eqn06959)、![](../graphics/stm_eqn06880)和![](../graphics/stm_eqn06881)值。
### Ogden形式
