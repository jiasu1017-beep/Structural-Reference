...
A sequence of connected [Edge](pt01ch07pyo03.md) objects specifying the geometry edges from which to offset the points.
...
### 20.1.4 DatumAxisByCylFace(...)

This method creates a Feature object and a [DatumAxis](pt01ch15pyo02.md) object along the axis of a cylinder or cone.
...
### 20.1.5 DatumAxisByNormalToPlane(...)

This method creates a Feature object and a [DatumAxis](pt01ch15pyo02.md) object normal to the specified plane and passing through the specified point.
...
A planar Face, an ElementFace, or a [Datum](pt01ch15pyo01.md) object representing a datum plane.

*point*

A Vertex, an InterestingPoint, a MeshNode, or a [Datum](pt01ch15pyo01.md) object representing a datum point.
...
### 20.1.6 DatumAxisByParToEdge(...)

This method creates a Feature object and a [DatumAxis](pt01ch15pyo02.md) object parallel to the specified edge and passing through the specified point.
...
A straight Edge, an ElementEdge, or a [Datum](pt01ch15pyo01.md) object representing a datum axis.
...
### 20.1.7 DatumAxisByPrincipalAxis(...)

This method creates a Feature object and a [DatumAxis](pt01ch15pyo02.md) object along one of the three principal axes.
...
### 20.1.8 DatumAxisByRotation(...)

This method creates a Feature object and a [DatumAxis](pt01ch15pyo02.md) object in a three-dimensional model by rotating a line about the specified axis through the specified angle.
...
A straight Edge, a [Datum](pt01ch15pyo01.md) object representing a datum axis, or an ElementEdge object specifying the line to rotate.

*axis*

A straight Edge, a [Datum](pt01ch15pyo01.md) object representing a datum axis, or an ElementEdge object specifying the axis about which to rotate the line.
...
### 20.1.9 DatumAxisByRotation(...)

This method creates a Feature object and a [DatumAxis](pt01ch15pyo02.md) object in a two-dimensional model by rotating a line about the specified point through the specified angle.
...
A Vertex, an InterestingPoint, a MeshNode, or a [Datum](pt01ch15pyo01.md) object representing a datum point specifying the point about which to rotate the line.
...
### 20.1.10 DatumAxisByThreePoint(...)

This method creates a Feature object and a [DatumAxis](pt01ch15pyo02.md) object normal to the circle described by three points and through its center.
...
A Vertex, an InterestingPoint, a MeshNode, or a [Datum](pt01ch15pyo01.md) object representing a datum point specifying the first point on the circle.

*point2*

A Vertex, an InterestingPoint, a MeshNode, or a [Datum](pt01ch15pyo01.md) object representing a datum point specifying the second point on the circle.

*point3*

A Vertex, an InterestingPoint, a MeshNode, or a [Datum](pt01ch15pyo01.md) object representing a datum point specifying the third point on the circle.
...
### 20.1.11 DatumAxisByThruEdge(...)

This method creates a Feature object and a [DatumAxis](pt01ch15pyo02.md) object along the specified edge.
...
### 20.1.12 DatumAxisByTwoPlane(...)

This method creates a Feature object and a [DatumAxis](pt01ch15pyo02.md) object at the intersection of two planes.
...
### 20.1.13 DatumAxisByTwoPoint(...)

This method creates a Feature object and a [DatumAxis](pt01ch15pyo02.md) object along the line joining two points.
...
### 20.1.14 DatumCsysByDefault(...)

This method creates a Feature object and a [DatumCsys](pt01ch15pyo03.md) object from the specified default coordinate system at the origin.
...
A String specifying the name of the [DatumCsys](pt01ch15pyo03.md).
...
### 20.1.15 DatumCsysByOffset(...)

This method creates a Feature object and a [DatumCsys](pt01ch15pyo03.md) object by offsetting the origin of an existing datum coordinate system to a specified point.
...
A [Datum](pt01ch15pyo01.md) object representing a datum coordinate system from which to offset.
...
### 20.1.16 DatumCsysByThreePoints(...)

This method creates a Feature object and a [DatumCsys](pt01ch15pyo03.md) object from three points.
...
A Vertex, an InterestingPoint, a MeshNode, or a [Datum](pt01ch15pyo01.md) object representing a datum point specifying the origin of the coordinate system.

*point1*

A Vertex, an InterestingPoint, a MeshNode, or a [Datum](pt01ch15pyo01.md) object representing a datum point specifying a point on the *X*-axis or the ![](../graphics/ker_eqn00052.gif)-axis. The *point1* and *line1* arguments are mutually exclusive. One of them must be specified.

*point2*

A Vertex, an InterestingPoint, a MeshNode, or a [Datum](pt01ch15pyo01.md) object representing a datum point specifying a point in the *X–Y* plane or the ![](../graphics/ker_eqn00052.gif)–![](../graphics/ker_eqn00053.gif) plane. The *point2* and *line2* arguments are mutually exclusive. One of them must be specified.

*line1*

An Edge, an Element Edge, or a [Datum](pt01ch15pyo01.md) object representing a datum axis specifying the *X*-axis or the ![](../graphics/ker_eqn00052.gif)-axis. The *point1* and *line1* arguments are mutually exclusive. One of them must be specified.

*line2*

An Edge, an Element Edge, or a [Datum](pt01ch15pyo01.md) object representing a datum axis specifying a vector in the *X–Y* plane or the ![](../graphics/ker_eqn00052.gif)–![](../graphics/ker_eqn00053.gif) plane. The *point2* and *line2* arguments are mutually exclusive. One of them must be specified.
...
### 20.1.17 DatumCsysByTwoLines(...)

This method creates a Feature object and a [DatumCsys](pt01ch15pyo03.md) object from two orthogonal lines. The origin of the new datum coordinate system is placed at the intersection of the two lines.
...
A straight Edge, an ElementEdge, or a [Datum](pt01ch15pyo01.md) object representing a datum axis specifying the *X*-axis or the ![](../graphics/ker_eqn00052.gif)-axis.

*line2*

A straight Edge, an ElementEdge, or a [Datum](pt01ch15pyo01.md) object representing a datum axis specifying a line in the *X–Y* plane or in the ![](../graphics/ker_eqn00052.gif)–![](../graphics/ker_eqn00053.gif) plane.
...
### 20.1.18 DatumPlaneByPrincipalPlane(...)

This method creates a Feature object and a [DatumPlane](pt01ch15pyo04.md) object through the origin along one of the three principal planes.
...
### 20.1.19 DatumPlaneByOffset(...)

This method creates a Feature object and a [DatumPlane](pt01ch15pyo04.md) object offset by a specified distance from an existing plane.
...
### 20.1.20 DatumPlaneByOffset(...)

This method creates a Feature object and a [DatumPlane](pt01ch15pyo04.md) object offset from an existing plane and passing through the specified point.
...
### 20.1.21 DatumPlaneByRotation(...)

This method creates a Feature object and a [DatumPlane](pt01ch15pyo04.md) object by rotating a plane about the specified axis through the specified angle.
...
### 20.1.22 DatumPlaneByThreePoints(...)

This method creates a Feature object and a [DatumPlane](pt01ch15pyo04.md) object defined by passing through three points.
...
### 20.1.23 DatumPlaneByLinePoint(...)

This method creates a Feature object and a [DatumPlane](pt01ch15pyo04.md) object that pass through the specified line and through the specified point that does not lie on the line.
...
### 20.1.24 DatumPlaneByPointNormal(...)

This method creates a Feature object and a [DatumPlane](pt01ch15pyo04.md) object normal to the specified line and running through the specified point.
...
### 20.1.25 DatumPlaneByTwoPoint(...)

This method creates a Feature object and a [DatumPlane](pt01ch15pyo04.md) object midway between two points and normal to the line connecting the points.
...
### 20.1.26 DatumPointByCoordinate(...)

This method creates a Feature object and a [DatumPoint](pt01ch15pyo05.md) object at the point defined by the specified coordinates.
...
### 20.1.27 DatumPointByOffset(...)

This method creates a Feature object and a [DatumPoint](pt01ch15pyo05.md) object offset from an existing point by a vector.
...
### 20.1.28 DatumPointByMidPoint(...)

This method creates a Feature object and a [DatumPoint](pt01ch15pyo05.md) object midway between two points.
...
### 20.1.29 DatumPointByOnFace(...)

This method creates a Feature object and a [DatumPoint](pt01ch15pyo05.md) object on the specified face, offset from two edges.
...
A planar Face or a [Datum](pt01ch15pyo01.md) object representing a datum plane.

*edge1*

A straight Edge or a [Datum](pt01ch15pyo01.md) object representing a datum axis.
...
### 20.1.30 DatumPointByEdgeParam(...)

This method creates a Feature object and a [DatumPoint](pt01ch15pyo05.md) object along an edge at a selected distance from one end of the edge.
...
A Float specifying the distance along *edge* to the [DatumPoint](pt01ch15pyo05.md) object. Possible values are 0 ![](../graphics/ker_eqn00048.gif) *parameter* ![](../graphics/ker_eqn00048.gif) 1.
...
### 20.1.31 DatumPointByProjOnEdge(...)

This method creates a Feature object and a [DatumPoint](pt01ch15pyo05.md) object along an edge by projecting an existing point along the normal to the edge.
...
An Edge, an ElementEdge or a [Datum](pt01ch15pyo01.md) object representing a datum axis.
...
### 20.1.32 DatumPointByProjOnFace(...)

This method creates a Feature object and a [DatumPoint](pt01ch15pyo05.md) object on a specified face by projecting an existing point onto the face.
...
### 20.1.33 MakeSketchTransform(...)

 This method creates a [Transform](pt01ch07pyo14.md) object. A Transform object is a 4x3 matrix of Floats that represents the transformation from sketch coordinates to part coordinates.
...
A [Datum](pt01ch15pyo01.md) plane object or a planar [Face](pt01ch07pyo05.md) object specifying the sketch plane.
...
An [Edge](pt01ch07pyo03.md) or [DatumAxis](pt01ch15pyo02.md) object specifying the orientation of the sketch. If unspecified, the sketch is assumed to be oriented with the *Y*-direction pointing up.
...
### 20.1.34 PartitionCellByDatumPlane(...)
...
A sequence of [Cell](pt01ch07pyo01.md) objects specifying the cells to partition.

*datumPlane*

A [DatumPlane](pt01ch15pyo04.md) object.
...
### 20.1.35 PartitionCellByExtendFace(...)
...
### 20.1.36 PartitionCellByExtrudeEdge(...)
...
The [Edge](pt01ch07pyo03.md) objects to be extruded. The edges must be in the same plane. The edges must form a continuous chain, without branches. The edges must belong to the same [PartInstance](pt01ch06pyo04.md) object.

*line*

A straight [Edge](pt01ch07pyo03.md) or [DatumAxis](pt01ch15pyo02.md) object specifying the extrude direction. *line* must be perpendicular to the plane formed by *edges*.
...
### 20.1.37 PartitionCellByPatchNCorners(...)
...
A [Cell](pt01ch07pyo01.md) object specifying the cell to partition.

*cornerPoints*

A sequence of Vertex, InterestingPoint, or DatumPoint objects. 3 ![](../graphics/ker_eqn00013.gif) len(*cornerPoints*) ![](../graphics/ker_eqn00013.gif) 5. The corner points must not coincide.
...
### 20.1.38 PartitionCellByPatchNEdges(...)
...
A [Cell](pt01ch07pyo01.md) specifying the cell to partition.

*edges*

A sequence of [Edge](pt01ch07pyo03.md) objects bounding the patch. The edges must form a closed loop. The [Edge](pt01ch07pyo03.md) objects must belong to the same [PartInstance](pt01ch06pyo04.md) object as *cell*.
...
### 20.1.39 PartitionCellByPlaneNormalToEdge(...)
...
An [Edge](pt01ch07pyo03.md) object specifying the normal to the plane.

*point*

A [Vertex](pt01ch07pyo15.md), [InterestingPoint](pt01ch07pyo11.md), or [DatumPoint](pt01ch15pyo05.md) object specifying a point on *edge*.
...
### 20.1.40 PartitionCellByPlanePointNormal(...)
...
A [Vertex](pt01ch07pyo15.md), [InterestingPoint](pt01ch07pyo11.md), or [DatumPoint](pt01ch15pyo05.md) object specifying a point on the plane.

*normal*

A straight [Edge](pt01ch07pyo03.md) or [DatumAxis](pt01ch15pyo02.md) object specifying the normal to the plane.
...
### 20.1.42 PartitionCellBySweepEdge(...)
...
A sequence of [Edge](pt01ch07pyo03.md) objects to be swept. The edges must be in the same plane. The edges must form a continuous chain without branches. The Edge objects must all belong to the same [PartInstance](pt01ch06pyo04.md) object.

*sweepPath*

An [Edge](pt01ch07pyo03.md) object specifying the sweep path. The start of *sweepPath* must be in the plane and perpendicular to the plane formed by *edges*. The sweep path must be planar.
...
### 20.1.43 PartitionEdgeByDatumPlane(...)
...
A [DatumPlane](pt01ch15pyo04.md) object specifying the location of the partition.
...
A Float specifying the normalized distance along *edge* at which to partition. Possible values are 0.0 ![](../graphics/ker_eqn00048.gif) *parameter* ![](../graphics/ker_eqn00048.gif) 1.0.
...
An [InterestingPoint](pt01ch07pyo11.md) or [DatumPoint](pt01ch15pyo05.md) object specifying a point on *edge*.
...
A [Face](pt01ch07pyo05.md) object specifying the face to partition.
...
### 20.1.47 PartitionFaceByCurvedPathEdgeParams(...)
...
An [Edge](pt01ch07pyo03.md) object specifying the start of the partition. The edge must belong to *face*.

*parameter1*

A Float specifying the distance along *edge1* at which to partition. Possible values are 0.0 ![](../graphics/ker_eqn00013.gif) *distance1* ![](../graphics/ker_eqn00013.gif) 1.0.

*edge2*

An [Edge](pt01ch07pyo03.md) object specifying the end of the partition. The edge must belong to *face*.

*parameter2*

A Float specifying the distance along *edge2* at which to partition. Possible values are 0.0 ![](../graphics/ker_eqn00013.gif) *distance2* ![](../graphics/ker_eqn00013.gif) 1.0.
...
### 20.1.48 PartitionFaceByCurvedPathEdgePoints(...)
...
A [Vertex](pt01ch07pyo15.md), [InterestingPoint](pt01ch07pyo11.md), or [DatumPoint](pt01ch15pyo05.md) object specifying a point on *edge1*.
...
A [Vertex](pt01ch07pyo15.md), [InterestingPoint](pt01ch07pyo11.md), or [DatumPoint](pt01ch15pyo05.md) object specifying a point on *edge2*.
...
### 20.1.49 PartitionFaceByDatumPlane(...)
...
A sequence of [Face](pt01ch07pyo05.md) objects specifying the faces to partition.
...
### 20.1.50 PartitionFaceByExtendFace(...)
...
A [Face](pt01ch07pyo05.md) object that is to be extended to create the partition. The face to extend can be a planar, cylindrical, conical, or spherical face.
...
### 20.1.51 PartitionFaceByIntersectFace(...)
...
### 20.1.52 PartitionFaceByProjectingEdges(...)
...
A sequence of [Edge](pt01ch07pyo03.md) objects specifying the edges that will be projected onto the target faces.
...
### 20.1.53 PartitionFaceByShortestPath(...)
...
A sequence of [Face](pt01ch07pyo05.md) objects specifying the face to partition.

*point1*

A [Vertex](pt01ch07pyo15.md), [InterestingPoint](pt01ch07pyo11.md), or [DatumPoint](pt01ch15pyo05.md) object.
...
A [ConstrainedSketch](pt01ch48pyo01.md) object specifying the partition.

**Optional arguments**

*sketchUpEdge*

An [Edge](pt01ch07pyo03.md) or [DatumAxis](pt01ch15pyo02.md) object specifying the orientation of *sketch*. This edge or datum axis must not be orthogonal to the plane defined by *faces*. If unspecified, *sketch* is assumed to be oriented in with the *Y* direction pointing up.
...
### 20.1.55 PartitionFaceBySketchDistance(...)
...
A Float specifying the projection distance. Possible values are *distance* ![](../graphics/ker_eqn00060.gif) 0.0.
...
### 20.1.56 PartitionFaceBySketchRefPoint(...)
...
An [Edge](pt01ch07pyo03.md) object or a DatumAxis object specifying the orientation of *sketch*. This edge or datum axis must not be orthogonal to *sketchPlane*.
...
A [Vertex](pt01ch07pyo15.md), [InterestingPoint](pt01ch07pyo11.md), or [DatumPoint](pt01ch15pyo05.md) object specifying the distance to project *sketch*. The point must not lie on *sketchPlane*.
...
### 20.1.57 PartitionFaceBySketchThruAll(...)
...
An [Edge](pt01ch07pyo03.md) or a DatumAxis object specifying the orientation of *sketch*. This edge or datum axis must not be orthogonal to *sketchPlane*.
...
### 20.1.58 ReferencePoint(...)

This method creates a Feature object and a [ReferencePoint](pt01ch07pyo13.md) object at the specified location.
...
A [Vertex](pt01ch07pyo15.md), [InterestingPoint](pt01ch07pyo11.md), a [MeshNode](pt01ch31pyo09.md), or a [Datum](pt01ch15pyo01.md) object specifying a reference point. *point* can also be a sequence of three Floats representing the *X*-, *Y*-, and *Z*-coordinates of the point.
...
A Float specifying the normalized distance along *edge* at which to partition. Possible values are 0.0 ![](../graphics/ker_eqn00048.gif) *parameter* ![](../graphics/ker_eqn00048.gif) 1.0. You use this argument to modify a partition created with the created with the `PartitionEdgeByParam` method.

*parameter1*

A Float specifying the distance along *edge1* at which to partition. Possible values are 0.0 ![](../graphics/ker_eqn00013.gif) *parameter1* ![](../graphics/ker_eqn00013.gif) 1.0. You use this argument to modify a partition object created with the `PartitionFaceByCurvedPathEdgeParam` method.

*parameter2*

A Float specifying the distance along *edge2* at which to partition. Possible values are 0.0 ![](../graphics/ker_eqn00013.gif) *parameter2* ![](../graphics/ker_eqn00013.gif) 1.0. You use this argument to modify a partition object created with the `PartitionFaceByCurvedPathEdgeParam` method.

*sketch*

A [ConstrainedSketch](pt01ch48pyo01.md) object specifying the partition.  You use this argument to modify a partition object created with a sketch; for example, using the `PartitionFaceBySketch` method.

*distance*

A Float specifying the projection *distance*. Possible values are *distance* ![](../graphics/ker_eqn00060.gif) 0.0. You use this argument to modify a partition object created with the `PartitionFaceBySketchDistance` method.
