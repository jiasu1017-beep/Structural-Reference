...
### 29.32.4 JohnsonCookDamageInitiation(...)
...
The optional arguments to `setValues` are the same as the arguments to the [DamageInitiation](pt01ch29pyo32.md#ker-damageinitiation-ductiledamageinitiation-pyc) method.
...
A [DamageEvolution](pt01ch29pyo31.md) object.

*damageStabilization*

A [DamageStabilization](pt01ch29pyo33.md) object.

*damageStabilizationCohesive*

A [DamageStabilizationCohesive](pt01ch29pyo34.md) object.
