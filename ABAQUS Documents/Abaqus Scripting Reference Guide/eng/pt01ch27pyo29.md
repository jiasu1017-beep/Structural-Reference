...
The ConnectorMoment object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [ConnectorMoment](pt01ch27pyo29.md#ker-connectormoment-connectormoment-pyc) method, except for the *name* and *createStepName* arguments.
