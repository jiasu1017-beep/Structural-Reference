...
硬化/软化假设控制有效应力空间中屈服面的大小。硬化/软化假定仅依赖于体积塑性应变分量，并且当体积塑性应变是压缩的（即当土骨架被压实）时，屈服面尺寸增大，而土骨架体积的非弹性增加导致屈服面收缩。在（![](../graphics/stm_eqn06188.gif))平面上选择屈服面的椭圆弧，结合相关流动假设，因此导致材料在屈服状态![](../graphics/stm_eqn06189.gif)在临界状态线左侧，[图4.4.3-2](04s04a115.md)中，"干燥"侧）软化，在屈服状态![](../graphics/stm_eqn06190.gif)在临界状态线右侧，[图4.4.3-3](04s04a115.md)中，"湿润"侧）硬化。
...
![](../graphics/stm_eqn06192.gif)其中*J*是当前体积与原始体积的比值，![](../graphics/stm_eqn06193.gif)当前与原始土颗粒体积的比值，![](../graphics/stm_eqn05454.gif)当前与原始土体积比的弹性（可恢复）部分，![](../graphics/stm_eqn05453.gif)当前与原始土体积比的塑性（不可恢复）部分。
...
![](../graphics/stm_eqn06197.gif)其中![](../graphics/stm_eqn00064.gif)单位矩阵。
### 弹性行为
...
![](../graphics/stm_eqn06200.gif)![](../graphics/stm_eqn01111.gif)![](../graphics/stm_eqn06201.gif)![](../graphics/stm_eqn06202.gif)![](../graphics/stm_eqn06203.gif)![](../graphics/stm_eqn06151.gif)![](../graphics/stm_eqn06204.gif)![](../graphics/stm_eqn06205.gif)![](../graphics/stm_eqn06097.gif)在此方程中，![](../graphics/stm_eqn06200.gif)用户指定的常数，可以是温度![](../graphics/stm_eqn01111.gif)其他预定义场变量![](../graphics/stm_eqn06201.gif)函数。该常数用于修改临界状态"湿润"侧屈服面的形状，因此在临界状态"湿润"侧的椭圆弧与"干燥"侧使用的椭圆弧具有不同的曲率：在临界状态"干燥"侧![](../graphics/stm_eqn06202.gif)而在大多数情况下"湿润"侧![](../graphics/stm_eqn06203.gif)如图[图4.4.3-4](04s04a115.md)所示。![](../graphics/stm_eqn06151.gif)义了塑性模型的硬化，它是*p*轴上椭圆弧与临界状态线交会的点的位置，如图[图4.4.3-4](04s04a115.md)所示。![](../graphics/stm_eqn06204.gif)*p*-*t*平面中临界状态线的斜率（临界状态下*t*与*p*的比值）；且![](../graphics/stm_eqn06205.gif)其中*g*用于在![](../graphics/stm_eqn06097.gif)面上形成屈服面，定义为

![](../graphics/stm_eqn06206.gif)其中![](../graphics/stm_eqn06207.gif)用户定义的常数。如果![](../graphics/stm_eqn06208.gif)屈服面不依赖于第三应力不变量，![](../graphics/stm_eqn06097.gif)面上屈服面截面是一个圆：这 choice gives the original form of the Cam-clay model. *K*的不同值对![](../graphics/stm_eqn06097.gif)面上屈服面形状的影响如图[图4.4.3-5](04s04a115.md)所示。为确保屈服面的凸性，![](../graphics/stm_eqn06121.gif)。
...
![](../graphics/stm_eqn00280.gif)![](../graphics/stm_eqn06209.gif)其中![](../graphics/stm_eqn00280.gif)常数。积分这个方程，并利用[公式4.4.3-1](04s04a115.md)、[公式4.4.1-2](04s04a113.md)和[公式4.4.1-4](04s04a113.md)，我们得到

![](../graphics/stm_eqn06210.gif)其中![](../graphics/stm_eqn06211.gif)义了分析开始时*a*的位置——材料的初始超固结。![](../graphics/stm_eqn06211.gif)值可以直接由用户指定，也可以计算为

![](../graphics/stm_eqn06212.gif)其中![](../graphics/stm_eqn01918.gif)等效压力应力的初始值，且![](../graphics/stm_eqn03838.gif)是在孔隙比与等效压力应力图上原始压缩线与孔隙比轴的截距，如图[图4.4.3-6](04s04a115.md)所示。
...
![](../graphics/stm_eqn06211.gif)![](../graphics/stm_eqn06217.gif)![](../graphics/stm_eqn06216.gif)![](../graphics/stm_eqn06215.gif)Note that the volumetric plastic strain axis has an arbitrary origin: ![](../graphics/stm_eqn06216.gif)体积塑性应变轴上对应于材料初始状态的位置上的值，从而定义了初始静水压力，![](../graphics/stm_eqn06217.gif)因此初始屈服面大小，![](../graphics/stm_eqn06211.gif)

图4.4.3-7 分段线性硬化/软化曲线。

![](../graphics/cclayplas-hard-soft.png)

![](../graphics/stm_eqn06211.gif)Abaqus检查初始有效应力状态是否在初始屈服面内部或之上。在任何违反屈服函数的材料点上，![](../graphics/stm_eqn06211.gif)调整使得[公式4.4.3-3](04s04a115.md)被精确满足（因此初始应力状态位于屈服面上）。
### 参考
