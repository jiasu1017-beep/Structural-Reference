...
| keyword | AFXObjectKeyword |  | 包含拾取变量的对象关键字。AFXGuiCommand 的一部分。 |
...
设置拾取边时使用的 refinements。
| **参数** | **类型** | **默认值** | **说明** |
| --- | --- | --- | --- |
| refinement | Int |  | Refinement 标志。 |

### setElementEdgeRefinements(refinement)

设置拾取元素边时使用的 refinements。
| **参数** | **类型** | **默认值** | **说明** |
| --- | --- | --- | --- |
| refinement | Int |  | Refinement 标志。 |
...
| **STRINGERS** | 允许拾取纵肋。 |
| **SKINS** | 允许拾取蒙皮。 |
| **ELEMENT_EDGES** | 允许拾取单元边。 |
| **ELEMENT_FACES** | 允许拾取单元面。 |
| **NODES** | 允许拾取节点。 |
| **ELEMENTS** | 允许拾取单元。 |
| **INSTANCES** | 允许拾取模型数据库中的部件实例。 |
...
| **SKETCH_COORDINATES** | 允许拾取草图坐标，必须添加 keyin。 |
