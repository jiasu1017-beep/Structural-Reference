...
To discuss the dynamic procedures further, we write out the d'Alembert force in the overall equilibrium equation, [Equation 2.1.1&#8211;1](02s01a13.md). The body force at a point, ![](../graphics/stm_eqn00480.gif), can be written as an externally prescribed body force, ![](../graphics/stm_eqn00319.gif), and a d'Alembert force:
...
![](../graphics/stm_eqn00894.gif)that is, the consistent mass matrix times the accelerations of the nodal variables. The finite element approximation to equilibrium, [Equation 2.1.1&#8211;2](02s01a13.md), is
...
The backward Euler operator solves the equilibrium equation ([Equation 2.4.1&#8211;1](02s04a19.md)) at the end of the time step and updates the displacement and velocity using

![](../graphics/stm_eqn00927.gif)and

![](../graphics/stm_eqn00928.gif)

The automatic time stepping for dynamic problems in Abaqus is based on the half-increment residual first proposed in [Hibbitt and Karlsson (1979)](07s01a01-References.md). The concept is quite appealing intuitively. Satisfaction of [Equation 2.4.1&#8211;1](02s04a19.md) at the end of each time step (or actually of the Hilber-Hughes-Taylor form, [Equation 2.4.1&#8211;2](02s04a19.md)) ensures equilibrium in the discrete sense of the finite element model at these points in time but does not say anything about the quality of equilibrium at intermediate time points. The idea of the half-increment residual is to calculate the equilibrium residual error (the left-hand side of [Equation 2.4.1&#8211;1](02s04a19.md)) at some intermediate time point (chosen as ![](../graphics/stm_eqn00885.gif)) and to assess the error in the dynamic response prediction by the magnitude of that error.
