...
Region commands are used to create part and assembly sets or surfaces from elements, nodes, and geometry. For more information, see ["Specifying a region," Section 6.6 of the Abaqus Scripting User's Guide](../cmd/cmd-link.md#cmd-int-acl-regions). Part and assembly objects have the following member, a repository of Set objects:
- *sets*

In turn, a Set object can contain any one of the following types:- elements
- nodes
- geometry
