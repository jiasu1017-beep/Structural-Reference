...
The CoriolisForce object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [CoriolisForce](pt01ch27pyo31.md#ker-coriolisforce-coriolisforce-pyc) method, except for the *name* and *createStepName* arguments.
