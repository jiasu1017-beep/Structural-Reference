# 60.8 CapCreepCohesion 对象

CapCreepCohesion 对象用于指定帽盖蠕变模型和材料特性。
...
CapCreepCohesion 对象的成员与 [CapCreepCohesion](pt02ch60pyo08.md#ker-capcreepcohesion-capcreepcohesion-cpp) 方法的参数具有相同的名称和描述。
