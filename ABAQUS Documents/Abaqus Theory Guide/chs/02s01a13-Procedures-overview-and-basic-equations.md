...
本节描述了标准基于位移的有限元分析的基本方程。我们从平衡陈述开始，写成虚功原理的形式，[方程 1.5.1-6](01s05a08.md)：
...
因此，连续体变分陈述 [方程 2.1.1-1](02s01a13.md) 被有限集 ![](../graphics/stm_eqn00660.gif) 上的变分近似。
...
接下来考虑 [方程 2.1.1-3](02s01a13.md) 中的外部荷载率项。一般来说，这些荷载向量可以写成
...
![](../graphics/stm_eqn00689.gif)其中 ![](../graphics/stm_eqn00690.gif) 直接从插值函数获得，我们可以将 [方程 2.1.1-3](02s01a13.md) 最后四项的Jacobian项写成
...
因此，给定插值函数和要使用的本构理论，[方程 2.1.1-2](02s01a13.md) 和 [方程 2.1.1-4](02s01a13.md) 为Newton增量求解提供了基础。
### 参考
