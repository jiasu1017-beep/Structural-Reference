...
OperatorFilter 对象定义运算符过滤器。

OperatorFilter 对象派生自 [Filter](pt02ch59pyo01.md) 对象。
...
`setValues` 的可选参数与 [OperatorFilter](pt02ch59pyo05.md#ker-operatorfilter-operatorfilter-cpp) 方法的参数相同，但 *name* 参数除外。
...
OperatorFilter 对象具有与 [OperatorFilter](pt02ch59pyo05.md#ker-operatorfilter-operatorfilter-cpp) 方法的参数具有相同名称和描述的成员。
