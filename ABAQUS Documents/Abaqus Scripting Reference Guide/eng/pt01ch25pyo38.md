# 25.38 FluidExchangeProperty object
...
The FluidExchangeProperty object is derived from the [InteractionProperty](pt01ch25pyo48.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [FluidExchangeProperty](pt01ch25pyo38.md#ker-fluidexchangeproperty-fluidexchangeproperty-pyc) method, except for the *name* argument.
...
The FluidExchangeProperty object has members with the same names and descriptions as the arguments to the [FluidExchangeProperty](pt01ch25pyo38.md#ker-fluidexchangeproperty-fluidexchangeproperty-pyc) method.
