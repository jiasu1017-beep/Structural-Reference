# 12.14 TangentialBehavior object
...
The optional arguments to `setValues` are the same as the arguments to the [TangentialBehavior](pt01ch12pyo14.md#ker-tangentialbehavior-tangentialbehavior-pyc) method.
...
The TangentialBehavior object has members with the same names and descriptions as the arguments to the [TangentialBehavior](pt01ch12pyo14.md#ker-tangentialbehavior-tangentialbehavior-pyc) method.

### 12.14.4 Corresponding analysis keywords
