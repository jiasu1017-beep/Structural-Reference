...
### *DECHARGEInput distributed electric charges for piezoelectric analysis.
...
Set OP=MOD (default) for existing [*DECHARGE](ch04abk10.md)s to remain, with this option defining electric charges to be added or modified. Set OP=NEW if all existing [*DECHARGE](ch04abk10.md)s applied to the model should be removed.
...
Repeat this data line as often as necessary to define distributed electric charges for various elements or element sets.
