...
![](../graphics/stm_eqn05500.gif)其中![](../graphics/stm_eqn05501.gif)和![](../graphics/stm_eqn05502.gif)分别是参考节点和耦合节点的位置。对于任意数量的耦合节点，[公式3.9.8-1](03s09a99.md)没有唯一解。
...
初始应力刚度项从[公式3.9.8-2](03s09a99.md)所示精确虚功表达式的适当近似推导。这个近似基于无穷小增量运动![](../graphics/stm_eqn05518.gif)和![](../graphics/stm_eqn05519.gif)的假设，这意味着
