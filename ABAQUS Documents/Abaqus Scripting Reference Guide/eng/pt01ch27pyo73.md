...
The SurfaceTraction object is derived from the [Load](pt01ch27pyo01.md) object.
...
A [VertexArray](pt01ch07pyo15.md) object of length 2 specifying the direction of the load. Instead of through a [Vertex](pt01ch07pyo15.md), each point may be specified through a tuple of coordinates. If *traction* is SHEAR, then *directionVector* will be projected onto the region surface. This parameter is available only if *traction* is GENERAL or SHEAR.
...
The optional arguments to `setValues` are the same as the arguments to the [SurfaceTraction](pt01ch27pyo73.md#ker-surfacetraction-surfacetraction-pyc) method, except for the *name* and *createStepName* arguments.
