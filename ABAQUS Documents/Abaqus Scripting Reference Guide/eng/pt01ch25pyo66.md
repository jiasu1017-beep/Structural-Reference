...
The StdContactControl object is derived from the [ContactControl](pt01ch25pyo16.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [StdContactControl](pt01ch25pyo66.md#ker-stdcontactcontrol-stdcontactcontrol-pyc) method, except for the *name* argument.
...
The StdContactControl object has members with the same names and descriptions as the arguments to the [StdContactControl](pt01ch25pyo66.md#ker-stdcontactcontrol-stdcontactcontrol-pyc) method.
