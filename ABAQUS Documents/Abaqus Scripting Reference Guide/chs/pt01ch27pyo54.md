# 27.54 RotationalBodyForce object
...
The RotationalBodyForce object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [RotationalBodyForce](pt01ch27pyo54.md#ker-rotationalbodyforce-rotationalbodyforce-pyc) method, except for the *name* and *createStepName* arguments.
