# 25.78 ThermalConductance object
...
The optional arguments to `setValues` are the same as the arguments to the [ThermalConductance](pt01ch25pyo78.md#ker-thermalconductance-thermalconductance-pyc) method.
...
The ThermalConductance object has members with the same names and descriptions as the arguments to the [ThermalConductance](pt01ch25pyo78.md#ker-thermalconductance-thermalconductance-pyc) method.
