...
The ContourOptions object is derived from the [DGContourOptions](pt01ch40pyo03.md) object.
...
An Int specifying the number of intervals when *contourStyle*=UNIFORM. Possible values are 2 ![](../graphics/ker_eqn00013.gif) *numIntervals* ![](../graphics/ker_eqn00013.gif) 24. The default value is 12.
...
A Float specifying the contour range minimum value to be used in the plot when *maxAutoCompute*=ON. The default value is *minAutoValue*.
...
A Float specifying the base contour value defining the tick mark axis contour value that intersects the elements. Possible values are *autoMinValue* ![](../graphics/ker_eqn00013.gif) *tickmarkBaseValue* ![](../graphics/ker_eqn00013.gif) *autoMaxValue*. The default value is 0.0.
