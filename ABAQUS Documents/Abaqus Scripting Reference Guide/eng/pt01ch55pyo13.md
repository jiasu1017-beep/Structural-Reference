...
A String specifying the name of the font to be used when drawing text with this TextStyle object. The default value is "-*-arial-medium-r-normal-*-*-140-*-*-p-*-*-*".
...
The TextStyle object has members with the same names and descriptions as the arguments to the [setValues](pt01ch55pyo13.md#ker-textstyle-setvalues-pyc) method.
