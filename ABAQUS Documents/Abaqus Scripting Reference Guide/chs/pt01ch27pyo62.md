...
The SurfaceCharge object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [SurfaceCharge](pt01ch27pyo62.md#ker-surfacecharge-surfacecharge-pyc) method, except for the *name* and *createStepName* arguments.
