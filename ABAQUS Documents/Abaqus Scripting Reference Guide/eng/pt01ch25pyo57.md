# 25.57 RadiationToAmbient object
...
The RadiationToAmbient object is derived from the [Interaction](pt01ch25pyo01.md) object.
...
A [Region](pt01ch45pyo03.md) object specifying the surface to which the radiation interaction is applied.
...
A Float specifying the reference ambient temperature, ![](../graphics/ker_eqn00061.gif). This argument applies only when *radiationType*=AMBIENT. The default value is 0.0.
...
The optional arguments to `setValues` are the same as the arguments to the [RadiationToAmbient](pt01ch25pyo57.md#ker-radiationtoambient-radiationtoambient-pyc) method, except for the *name* and *createStepName* arguments.
...
The optional arguments to `setValuesInStep` are the same as the arguments to the [RadiationToAmbient](pt01ch25pyo57.md#ker-radiationtoambient-radiationtoambient-pyc) method, except for the *name*, *createStepName*, and *surface* arguments.
None.
...
The RadiationToAmbient object has members with the same names and descriptions as the arguments to the [RadiationToAmbient](pt01ch25pyo57.md#ker-radiationtoambient-radiationtoambient-pyc) method.
