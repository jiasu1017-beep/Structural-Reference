...
![](../graphics/stm_eqn06321.gif)![](../graphics/stm_eqn06321.gif)Mises应力

![](../graphics/stm_eqn06322.gif)![](../graphics/stm_eqn06322.gif)义。屈服面定义为

![](../graphics/stm_eqn06323.gif)![](../graphics/stm_eqn06323.gif)动势定义为

![](../graphics/stm_eqn06324.gif)![](../graphics/stm_eqn00904.gif)![](../graphics/stm_eqn01219.gif)![](../graphics/stm_eqn01918.gif)![](../graphics/stm_eqn06324.gif)*F*和*G*在*p*-*q*应力平面上都可以表示为椭圆，其中![](../graphics/stm_eqn00904.gif)![](../graphics/stm_eqn01219.gif)别表示屈服椭圆和流动势椭圆的形状；![](../graphics/stm_eqn01918.gif)屈服椭圆的中心，*B*是屈服椭圆（垂直）*q*轴的长度。流动势是一个以原点为中心的椭圆。屈服面和流动势如图[图4.4.6-1](04s04a118.md)所示。

图4.4.6-1 可压碎泡沫模型的典型屈服面和流动势。

![](../graphics/ccrushfoam-gen-nls.png)

![](../graphics/stm_eqn01918.gif)![](../graphics/stm_eqn01917.gif)![](../graphics/stm_eqn06155.gif)屈服椭圆（[公式4.4.6-2](04s04a118.md)）的参数![](../graphics/stm_eqn01918.gif)*B*与静水压缩中的屈服强度![](../graphics/stm_eqn01917.gif)静水拉伸中的屈服强度![](../graphics/stm_eqn06155.gif)关系为

![](../graphics/stm_eqn06325.gif)![](../graphics/stm_eqn01917.gif)![](../graphics/stm_eqn06155.gif)![](../graphics/stm_eqn06325.gif)中![](../graphics/stm_eqn01917.gif)![](../graphics/stm_eqn06155.gif)正值，*A*是屈服椭圆（水平）*p*轴的长度。

![](../graphics/stm_eqn00904.gif)![](../graphics/stm_eqn06326.gif)![](../graphics/stm_eqn06327.gif)![](../graphics/stm_eqn05764.gif)形状因子![](../graphics/stm_eqn00904.gif)任何塑性变形过程中保持为常数。屈服椭圆的演化由塑性应变测度![](../graphics/stm_eqn06326.gif)制，对于体积硬化模型，它是体积压实塑性应变![](../graphics/stm_eqn06327.gif)对于各向同性硬化模型，它是等效塑性应变![](../graphics/stm_eqn05764.gif)稍后定义）。

为定义硬化行为，需要单轴压缩试验数据。必须以表格形式输入单轴Cauchy应力与轴向（对数）塑性应变的分段线性硬化曲线。
### 带体积硬化的可压碎泡沫模型

![](../graphics/stm_eqn06155.gif)体积硬化模型假定静水拉伸强度![](../graphics/stm_eqn06155.gif)任何塑性变形过程中保持恒定。相比之下，静水压缩强度随材料的压实（密度增加）或膨胀（密度减少）而演化：

![](../graphics/stm_eqn06328.gif)![](../graphics/stm_eqn06328.gif)服面
...
![](../graphics/stm_eqn06329.gif)![](../graphics/stm_eqn00904.gif)![](../graphics/stm_eqn06330.gif)![](../graphics/stm_eqn06331.gif)![](../graphics/stm_eqn06155.gif)![](../graphics/stm_eqn06329.gif)中参数![](../graphics/stm_eqn00904.gif)示*p*-*q*应力平面上屈服椭圆的形状，可以从单轴压缩中的初始屈服强度![](../graphics/stm_eqn06330.gif)取正值）、静水压缩中的初始屈服强度![](../graphics/stm_eqn06331.gif)静水拉伸中的屈服强度![](../graphics/stm_eqn06155.gif)算为

![](../graphics/stm_eqn06332.gif)![](../graphics/stm_eqn06333.gif)![](../graphics/stm_eqn06334.gif)![](../graphics/stm_eqn06335.gif)![](../graphics/stm_eqn06336.gif)![](../graphics/stm_eqn06332.gif)中应力比![](../graphics/stm_eqn06333.gif)![](../graphics/stm_eqn06334.gif)用户提供，可以是温度和其他场变量的函数。对于有效的屈服面，应力比的选择必须使![](../graphics/stm_eqn06335.gif)![](../graphics/stm_eqn06336.gif)屈服面在偏量应力平面上是Mises圆。
### 流动势
...
![](../graphics/stm_eqn06339.gif)*G*是流动势，在此模型中选择为
![](../graphics/stm_eqn06340.gif)![](../graphics/stm_eqn06341.gif)
![](../graphics/stm_eqn06340.gif)![](../graphics/stm_eqn06341.gif)![](../graphics/stm_eqn06340.gif)势是[公式4.4.6-3](04s04a118.md)的一个特例，其中![](../graphics/stm_eqn06341.gif)*p*-*q*应力平面上流动势的几何表示如图[图4.4.6-2](04s04a118.md)所示。
...
![](../graphics/stm_eqn06348.gif)中

![](../graphics/stm_eqn06349.gif)![](../graphics/stm_eqn00904.gif)示*p*-*q*应力平面上屈服椭圆的形状，*B*定义屈服椭圆的大小，![](../graphics/stm_eqn01917.gif)静水压缩中的屈服强度，![](../graphics/stm_eqn05864.gif)单轴压缩中屈服强度的绝对值。屈服面在偏量应力平面上是Mises圆，在子午面上是椭圆，如图[图4.4.6-3](04s04a118.md)所示。
...
![](../graphics/stm_eqn06352.gif)中![](../graphics/stm_eqn01219.gif)示*p*-*q*应力平面上流动势的形状，并与塑性泊松比![](../graphics/stm_eqn06353.gif)关，关系为

![](../graphics/stm_eqn06356.gif)![](../graphics/stm_eqn06357.gif)![](../graphics/stm_eqn06358.gif)![](../graphics/stm_eqn05764.gif)![](../graphics/stm_eqn05764.gif)![](../graphics/stm_eqn06354.gif)性泊松比，即单轴压缩中横向与纵向塑性应变之比，应由用户定义；它必须在1到0.5的范围内。上限![](../graphics/stm_eqn06355.gif)应不可压缩塑性流动。

![](../graphics/stm_eqn06359.gif)塑性应变假定正交于一族自相似流动势，以势*G*的值参数化

![](../graphics/stm_eqn01219.gif)![](../graphics/stm_eqn00904.gif)![](../graphics/stm_eqn06360.gif)![](../graphics/stm_eqn06356.gif)中![](../graphics/stm_eqn06357.gif)非负塑性流动乘子。泡沫的硬化通过![](../graphics/stm_eqn06358.gif)述，其中![](../graphics/stm_eqn05764.gif)等效塑性应变。![](../graphics/stm_eqn05764.gif)演化假定由等效塑性功表达式控制，即

![](../graphics/stm_eqn06347.gif)![](../graphics/stm_eqn06359.gif)效塑性应变等于单轴拉伸或压缩中轴向塑性应变的绝对值。
