...
The Chebyshev1Filter object is derived from the [Filter](pt01ch22pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [Chebyshev1Filter](pt01ch22pyo03.md#ker-chebyshev1filter-chebyshev1filter-pyc) method, except for the *name* argument.
...
The Chebyshev1Filter object has members with the same names and descriptions as the arguments to the [Chebyshev1Filter](pt01ch22pyo03.md#ker-chebyshev1filter-chebyshev1filter-pyc) method.
