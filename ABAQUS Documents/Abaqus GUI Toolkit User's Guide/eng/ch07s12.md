...
- The [*FREQUENCY](../key/key-link.md#usb-kws-hfrequency) procedure extracts the natural frequencies and mode shapes of the structure.
...
- Modal techniques are not suitable for nonlinear dynamic simulations. Direct time integration ([*DYNAMIC](../key/key-link.md#usb-kws-hdynamic)) methods must be used in these situations.
- The [*AMPLITUDE](../key/key-link.md#usb-kws-mamplitude) option allows any time variation of loads or prescribed boundary conditions to be defined.
