...
我们现在将运动学假设[公式3.6.7-1](03s06a85.md)引入![](../graphics/stm_eqn04687.gif)的定义中发现
...
![](../graphics/stm_eqn04698.gif)其中![](../graphics/stm_eqn04699.gif)且当前参考表面Jacobi行列式为![](../graphics/stm_eqn04700.gif)。在上述虚功表达式中，![](../graphics/stm_eqn04267.gif)项在![](../graphics/stm_eqn04701.gif)中被忽略。该项是![](../graphics/stm_eqn04702.gif)——其中*h*是厚度，*R*是某个特征曲率半径——根据运动学假设[公式3.6.7-1](03s06a85.md)可以忽略。壳应力分量由通过壳厚度的以下积分定义：
...
![](../graphics/stm_eqn04726.gif)从[公式3.6.7-5](03s06a85.md)可以得出，标准正交切向量由下式给出
...
我们现在用矩阵算子符号写出虚功表达式[公式3.6.7-4](03s06a85.md)。定义以下应力分量向量：

![](../graphics/stm_eqn04744.gif)定义矩阵应变-位移算子如下：

![](../graphics/stm_eqn04745.gif)其中![](../graphics/stm_eqn04746.gif)是零列![](../graphics/stm_eqn04747.gif)。然后，虚功表达式[公式3.6.7-4](03s06a85.md)等价为
...
![](../graphics/stm_eqn04759.gif)然后由[公式3.6.7-6](03s06a85.md)确定![](../graphics/stm_eqn04760.gif)和。
...
迭代求解过程需要计算一致切线刚度。这个刚度有两部分，一部分来自材料模型，另一部分来自变化的几何。我们用![](../graphics/stm_eqn04765.gif)表示二阶变分量。回到[公式3.6.7-4](03s06a85.md)，虚功表达式可以写成
...
1. **参考表面更新**：使用与[公式3.6.7-2](03s06a85.md)中总位移向量相同的插值方案对位移增量进行插值：

![](../graphics/stm_eqn04778.gif)参考表面位置映射通过位移增量更新为

![](../graphics/stm_eqn04779.gif)

2. **旋转场更新**：使用与[公式3.6.7-3](03s06a85.md)中总旋转场相同的插值方案对增量旋转场进行更新：
...
![](../graphics/stm_eqn04812.gif)[公式3.6.7-7](03s06a85.md)中的项可以如下展开：

![](../graphics/stm_eqn04813.gif)因此，

![](../graphics/stm_eqn04814.gif)变分![](../graphics/stm_eqn04815.gif)写成![](../graphics/stm_eqn04816.gif)，其中分量具有与[公式3.6.7-7](03s06a85.md)中相似的插值。因此，虚功贡献变为
