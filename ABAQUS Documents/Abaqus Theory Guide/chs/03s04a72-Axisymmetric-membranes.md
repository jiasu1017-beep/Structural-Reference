...
设![](../graphics/stm_eqn03061.gif)、![](../graphics/stm_eqn03062.gif)和![](../graphics/stm_eqn03063.gif)是点在未变形状态下沿径向、轴向和周向的单位向量，如图[图3.4.3-1](03s04a72.md)所示。

图3.4.3-1 柱面坐标系和位置向量定义。

![](../graphics/stmcylsys.png)点的参考位置![](../graphics/stm_eqn00141.gif)可以用原始半径*R*和轴向位置*Z*表示：

![](../graphics/stm_eqn03467.gif)类似地，设![](../graphics/stm_eqn03101.gif)、![](../graphics/stm_eqn03066.gif)和![](../graphics/stm_eqn03067.gif)是点在变形状态下沿径向、轴向和周向的单位向量。如[图3.4.3-1](03s04a72.md)所示，径向和周向基向量依赖于![](../graphics/stm_eqn01111.gif)坐标：![](../graphics/stm_eqn03468.gif)和![](../graphics/stm_eqn03069.gif)。
...
![](../graphics/stm_eqn03481.gif)使用[公式3.4.3-3](03s04a72.md)中基向量的定义，变形梯度张量的分量为
...
![](../graphics/stm_eqn03484.gif)回想Abaqus用相对于轴对称扭转自由度的固定空间基来公式化有限元方程。因此，[公式3.4.3-2](03s04a72.md)的线性化不能简单得到![](../graphics/stm_eqn03094.gif)所需的结果。也就是说，必须取消来自
