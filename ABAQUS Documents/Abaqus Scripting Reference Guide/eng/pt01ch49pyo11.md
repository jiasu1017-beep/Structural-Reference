...
The ExplicitDynamicsStep object is derived from the [AnalysisStep](pt01ch49pyo02.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [ExplicitDynamicsStep](pt01ch49pyo11.md#ker-explicitdynamicsstep-explicitdynamicsstep-pyc) method, except for the *name*, *previous*, and *maintainAttributes* arguments.
