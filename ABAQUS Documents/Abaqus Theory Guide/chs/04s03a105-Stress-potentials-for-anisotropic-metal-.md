...
![](../graphics/stm_eqn05675.gif)这里![](../graphics/stm_eqn00522.gif)偏应力：
...
![](../graphics/stm_eqn05678.gif)其中![](../graphics/stm_eqn05666.gif)四阶单位张量。

Hill应力函数是Mises函数的简单扩展以允许各向异性行为。函数为

![](../graphics/stm_eqn05679.gif)以直角笛卡尔应力分量表示，其中![](../graphics/stm_eqn05680.gif)从材料在不同取向上的测试获得的常数。它们定义为
...
![](../graphics/stm_eqn05686.gif)其中![](../graphics/stm_eqn05687.gif)用户指定，![](../graphics/stm_eqn05688.gif)![](../graphics/stm_eqn05596.gif)![](../graphics/stm_eqn05689.gif)当只有一个应力分量非零时使势等于![](../graphics/stm_eqn05690.gif)应力值。
...
![](../graphics/stm_eqn05678.gif)![](../graphics/stm_eqn05666.gif)"Anisotropic yield/creep," Section 23.2.6 of the Abaqus Analysis User's Guide
