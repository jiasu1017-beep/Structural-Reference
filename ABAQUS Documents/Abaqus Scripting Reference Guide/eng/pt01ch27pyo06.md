...
The BodyCurrent object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [BodyCurrent](pt01ch27pyo06.md#ker-bodycurrent-bodycurrent-pyc) method, except for the *name* and *createStepName* arguments.
