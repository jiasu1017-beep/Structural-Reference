...
![](../graphics/stm_eqn00505.gif)where ![](../graphics/stm_eqn00399.gif) is a particular choice of strain matrix, derived on the basis of the discussion in "Strain measures,"  Section 1.4.2, and ![](../graphics/stm_eqn00506.gif) is now the stress matrix that is work conjugate to ![](../graphics/stm_eqn00034.gif). [Equation 1.5.2&#8211;1](01s05a09.md) defines a conjugate stress measure for any chosen strain measure.

The internal virtual work rate was expressed in [Equation 1.5.1&#8211;6](01s05a08.md) directly in terms of Cauchy stress, and the virtual velocity gradient. This internal virtual work rate may be rewritten as an integral over the natural reference volume:
