...
The Area object is used to display a rectangular area in an XYPlot. The Area object has no constructor. Area objects are automatically created whenever a [XYPlot](pt01ch55pyo16.md), [Chart](pt01ch55pyo06.md), PlotTitle, or Legend objects are created.
...
An [AreaStyle](pt01ch55pyo03.md) object.

*border*

A [LineStyle](pt01ch55pyo10.md) object.
...
An [AreaStyle](pt01ch55pyo03.md) object specifying whether and how to fill the area.

*border*

A [LineStyle](pt01ch55pyo10.md) object specifying whether and how to draw the border of the area.
