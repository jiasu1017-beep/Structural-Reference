...
The ContourIntegral object is derived from the [Crack](pt01ch19pyo04.md) object.
...
A [RegionArray](pt01ch45pyo03.md) object specifying the crack-front region to which the contour integral is applied. If the crack-front consists of a single region, a [Region](pt01ch45pyo03.md) object may be specified instead of a sequence with a single item in it.

*crackTip*

A [RegionArray](pt01ch45pyo03.md) object specifying the crack-tip region to which the contour integral is applied. If the crack-tip consists of a single region, a [Region](pt01ch45pyo03.md) object may be specified instead of a sequence with a single item in it.
...
A Float specifying the position of the midside node along the edges of the second-order elements that radiate from the crack tip. Possible values are 0.0 ![](../graphics/ker_eqn00048.gif) *midNodeParameter* ![](../graphics/ker_eqn00048.gif) 1.0. The default value is 0.5.
...
The optional arguments to `setValues` are the same as the arguments to the [ContourIntegral](pt01ch19pyo03.md#ker-contourintegral-contourintegral-pyc) method, except for the *name* argument.
...
The ContourIntegral object has members with the same names and descriptions as the arguments to the [ContourIntegral](pt01ch19pyo03.md#ker-contourintegral-contourintegral-pyc) method.
...
### 19.3.4 Corresponding analysis keywords
