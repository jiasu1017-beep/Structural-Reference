# 9.11 ConnAccelerationBC object
...
The ConnAccelerationBC object is derived from the [BoundaryCondition](pt01ch09pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [ConnAccelerationBC](pt01ch09pyo11.md#ker-connaccelerationbc-connaccelerationbc-pyc) method, except for the *name* and *createStepName* arguments.
