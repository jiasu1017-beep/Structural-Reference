...
| --- | --- |
| CUBLAS_EMULATION_STRATEGY | An environment variable for overriding the default emulation strategy. The valid values are performant and eager; see cublasEmulationStrategy_t for more details. |
