# 9.20 DisplacementBCState object
...
The DisplacementBCState object stores the propagating data for a displacement/rotation boundary condition in a step. One instance of this object is created internally by the [DisplacementBC](pt01ch09pyo19.md) object for each step. The instance is also deleted internally by the [DisplacementBC](pt01ch09pyo19.md) object.

The DisplacementBCState object has no constructor or methods.

The DisplacementBCState object is derived from the [BoundaryConditionState](pt01ch09pyo08.md) object.
...
### 9.20.2 Corresponding analysis keywords

| [*BOUNDARY](../key/key-link.md#usb-kws-hboundary), TYPE=DISPLACEMENT (degree of freedom: 1, 2, 3, 4, 5, or 6) |
| --- |
