...
### *M2Define the second bending moment behavior of beams.

This option is used to define the second bending moment behavior of beams. It can be used only in conjunction with the [*BEAM GENERAL SECTION](ch02abk05.md), SECTION=NONLINEAR GENERAL option and is needed only for beams in space.
