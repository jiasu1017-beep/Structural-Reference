# 16.31 LeafFromPartNodeLabels object
...
The LeafFromPartNodeLabels object can be used whenever a [Leaf](pt01ch16pyo04.md) object is expected as an argument. [Leaf](pt01ch16pyo04.md) objects are used to specify the items in a display group. [Leaf](pt01ch16pyo04.md) objects are constructed as temporary objects, which are then used as arguments to [DisplayGroup](pt01ch16pyo01.md) commands.

The LeafFromPartNodeLabels object is derived from the [Leaf](pt01ch16pyo04.md) object.
...
### 16.31.1 LeafFromPartNodeLabels(...)
 ...
 This method creates a [Leaf](pt01ch16pyo04.md) object from a sequence of Strings specifying node labels. Leaf objects specify the items in a display group.
