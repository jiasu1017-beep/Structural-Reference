...
TiffOptions 对象存储 Abaqus 以 TIFF 格式打印时的设置。TiffOptions 对象没有构造函数。启动会话时，Abaqus 会创建 *tiffOptions* 成员。
...
TiffOptions 对象的成员与 [setValues](pt01ch43pyo07.md#ker-tiffoptions-setvalues-pyc) 方法的参数具有相同的名称和描述。
