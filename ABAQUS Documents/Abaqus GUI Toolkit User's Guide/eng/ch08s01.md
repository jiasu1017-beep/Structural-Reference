...
This type of nonlinearity is probably the one that you are most familiar with and is covered in more depth in [Chapter 10, "Materials](ch10.md).” Most metals have a fairly linear stress/strain relationship at low strain values; but at higher strains the material yields, at which point the response becomes nonlinear and irreversible (see [Figure 8--2](ch08s01.md#gss-elastplast)).

**Figure 8–2** Stress-strain curve for an elastic-plastic material under uniaxial tension.

![](../graphics/gss-elastplast-nls.png)

Rubber materials can be approximated by a nonlinear, reversible (elastic) response (see [Figure 8--3](ch08s01.md#gss-rubbertype)).
...
Boundary nonlinearity occurs if the boundary conditions change during the analysis. Consider the cantilever beam, shown in [Figure 8--4](ch08s01.md#gss-cantilever), that deflects under an applied load until it hits a “stop.”
...
Boundary nonlinearity is covered in [Chapter 12, "Contact](ch12.md).”
...
For example, consider a cantilever beam loaded vertically at the tip (see [Figure 8--5](ch08s01.md#gss-deflection)). 
...
One would expect large deflections and rotations to have a significant effect on the way that structures carry loads. However, displacements do not necessarily have to be large relative to the dimensions of the structure for geometric nonlinearity to be important. Consider the “snap through” under applied pressure of a large panel with a shallow curve, as shown in [Figure 8--6](ch08s01.md#gss-snap-through).
