...
The PEGLoadState object stores the propagating data for a concentrated force in a step. One instance of this object is created internally by the [PEGLoad](pt01ch27pyo45.md) object for each step. The instance is also deleted internally by the [PEGLoad](pt01ch27pyo45.md) object.

The PEGLoadState object has no constructor or methods.

The PEGLoadState object is derived from the [LoadState](pt01ch27pyo42.md) object.
...
### 27.46.2 Corresponding analysis keywords

| [*CLOAD](../key/key-link.md#usb-kws-hcload) (degree of freedom: 1 or 2) |
| --- |
