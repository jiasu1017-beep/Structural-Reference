...
The ConcPoreFluid object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [ConcPoreFluid](pt01ch27pyo26.md#ker-concporefluid-concporefluid-pyc) method, except for the *name* and *createStepName* arguments.
