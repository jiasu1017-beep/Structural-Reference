# 49.7 CoupledThermalElectricalStructuralStep 对象

CoupledThermalElectricalStructuralStep 对象用于分析需要温度、应力/位移和电场同时求解的问题。

CoupledThermalElectricalStructuralStep 对象派生于 [AnalysisStep](pt01ch49pyo02.md) 对象。
...
此方法创建一个 CoupledThermalElectricalStructuralStep 对象。
...
一个 CoupledThermalElectricalStructuralStep 对象。
...
此方法修改 CoupledThermalElectricalStructuralStep 对象。
...
`setValues` 的可选参数与 [CoupledThermalElectricalStructuralStep](pt01ch49pyo07.md#ker-coupledthermalelectricalstructuralstep-coupledtherma-pyc) 方法的参数相同，但 *name*、*previous* 和 *maintainAttributes* 参数除外。
...
CoupledThermalElectricalStructuralStep 对象可以具有以下成员：
