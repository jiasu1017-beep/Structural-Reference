...
![](../graphics/stm_eqn00999.gif)**产品：** Abaqus/Standard
...
![](../graphics/stm_eqn00986.gif)这些积分不容易计算，但通过以下修改，它们可以展开，使得（最初未知的）当前质心 ![](../graphics/stm_eqn00986.gif) 仅出现在与已知当前配置中粒子位置的乘积中。
...
![](../graphics/stm_eqn00993.gif)![](../graphics/stm_eqn00064.gif)"Abaqus Analysis User's Guide" 第6.3.2节"使用直接积分的隐式动力学分析"