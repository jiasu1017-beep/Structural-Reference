# 40.26 PlyStackPlotOptions object
...
The PlyStackPlotOptions object stores values and attributes associated with a[Viewport](pt01ch11pyo04.md) object. The PlyStackPlotOptions object has no constructor command. Abaqus creates the *detailPlotOptions.plyStackPlotPlotOptions* member whenever a [Viewport](pt01ch11pyo04.md) is created.
...
The PlyStackPlotOptions object has members with the same names and descriptions as the arguments to the [setValues](pt01ch40pyo26.md#ker-plystackplotoptions-setvalues-pyc) method.
