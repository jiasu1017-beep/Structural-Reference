...
The optional arguments to `setValues` are the same as the arguments to the [Piezoelectric](pt01ch29pyo75.md#ker-piezoelectric-piezoelectric-pyc) method.
...
The Piezoelectric object has members with the same names and descriptions as the arguments to the [Piezoelectric](pt01ch29pyo75.md#ker-piezoelectric-piezoelectric-pyc) method.

### 29.75.4 Corresponding analysis keywords
