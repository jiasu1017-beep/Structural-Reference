...
### *CENTROIDDefine the position of the centroid of the beam section.

This option can be used only in conjunction with the [*BEAM GENERAL SECTION](ch02abk05.md), SECTION=GENERAL or the [*BEAM GENERAL SECTION](ch02abk05.md), SECTION=MESHED option. It is used to define the position of the centroid of the section with respect to the local (1, 2) axis system.
