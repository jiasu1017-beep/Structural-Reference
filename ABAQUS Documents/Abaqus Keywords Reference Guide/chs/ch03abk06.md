...
### *CAST IRON COMPRESSION HARDENING指定灰铸铁塑性模型的压缩硬化。
...
将此参数设置为除了温度之外还包括在压缩屈服应力定义中的场变量依赖项数。如果省略此参数，则假定压缩屈服应力仅依赖于塑性应变，也可能依赖于温度。请参阅 ["材料数据定义"中的"指定场变量依赖性"，Abaqus 分析用户指南第 21.1.2 节](../usb/usb-link.md#usb-mat-cmaterialdata-fvdepen)，了解更多详细信息。
