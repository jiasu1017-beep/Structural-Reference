...
The OperatorFilter object is derived from the [Filter](pt01ch22pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [OperatorFilter](pt01ch22pyo05.md#ker-operatorfilter-operatorfilter-pyc) method, except for the *name* argument.
...
The OperatorFilter object has members with the same names and descriptions as the arguments to the [OperatorFilter](pt01ch22pyo05.md#ker-operatorfilter-operatorfilter-pyc) method.
