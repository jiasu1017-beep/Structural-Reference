...
A Float specifying the normalized distance along the edge of the midside nodes. Possible values are 0.0 ![](../graphics/ker_eqn00013.gif) *parameter* ![](../graphics/ker_eqn00013.gif) 1.0, where 0.0 specifies the position of the corner node. The default value is 0.5.
...
The elements to consider as the domain for the operation.  By default all elements on the part are considered.  The elements may be given as a [MeshElementArray](pt01ch31pyo05.md), a list of [MeshElement](pt01ch31pyo05.md) objects, a [Set](pt01ch45pyo04.md), or a list of [Set](pt01ch45pyo04.md) objects.

*refEdge*

A [MeshEdge](pt01ch31pyo04.md) specifying a reference edge to indicate a topological direction in a structured mesh that will limit which edges within the element domain are considered.  That is, only edges that are found to be topologically parallel to the given reference edge will be considered by the operation. By default all edges of the element domain are considered, unless *thicknessDir* is specified, in which case the operation will attempt to determine the topological edges from the thickness direction.
...
A [MeshEdge](pt01ch31pyo04.md) of one of the specified elements that serves as a reference edge to indicate the topological direction for merging elements.  All specified elements must be reachable by topological navigation from this element edge, and the topological direction must be unambiguous.

*elements*

A [MeshElementArray](pt01ch31pyo05.md), a list of [MeshElement](pt01ch31pyo05.md) objects, a [Set](pt01ch45pyo04.md), or a list of [Set](pt01ch45pyo04.md) objects containing the elements to be included in the merge operation.
...
A sequence of [MeshElement](pt01ch31pyo05.md) objects specifying the elements to orient.

*referenceRegion*

A [MeshFace](pt01ch31pyo08.md) object specifying a reference top face that indicates the desired orientation. 
...
A [MeshElementArray](pt01ch31pyo05.md) or a tuple or list of [MeshElement](pt01ch31pyo05.md) objects, or a [Set](pt01ch45pyo04.md) containing elements to be renumbered. If unspecified, all elements in the part will be renumbered.
...
A [MeshNodeArray](pt01ch31pyo09.md) or a tuple or list of [MeshNode](pt01ch31pyo09.md) objects, or a [Set](pt01ch45pyo04.md) containing nodes to be renumbered. If unspecified, all nodes in the part will be renumbered.
...
A Float specifying the normalized distance along *edge* at which to split. Possible values are 0.0 ![](../graphics/ker_eqn00048.gif) *parameter* ![](../graphics/ker_eqn00048.gif) 1.0. The default value is 0.5.
...
A [MeshElementArray](pt01ch31pyo05.md), a list of [MeshElement](pt01ch31pyo05.md) objects, a [Set](pt01ch45pyo04.md), or a list of [Set](pt01ch45pyo04.md) objects containing the elements to be subdivided. By default all the elements of the part are subdivided.
...
A Float specifying the radius of the cylinder about which the part is to be wrapped. The wrapping procedure will relocate a node at point (![](../graphics/ker_eqn00049.gif), ![](../graphics/ker_eqn00050.gif)) on the planar mesh to (![](../graphics/ker_eqn00051.gif)), where ![](../graphics/ker_eqn00052.gif) is the specified radius, ![](../graphics/ker_eqn00053.gif) = ![](../graphics/ker_eqn00054.gif), and ![](../graphics/ker_eqn00055.gif)=![](../graphics/ker_eqn00050.gif).
