...
### *FAIL STRAINDefine parameters for strain-based failure measures.

This option is used to define the strain limits for strain-based failure measures. It can be used only in conjunction with the [*ELASTIC](ch05abk03.md) option.
...
Repeat this set of data lines as often as necessary to define the failure criteria as a function of temperature and other predefined field variables.
