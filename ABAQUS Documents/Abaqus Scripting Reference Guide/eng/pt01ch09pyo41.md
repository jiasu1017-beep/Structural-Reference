...
The SubmodelBC object is derived from the [BoundaryCondition](pt01ch09pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [SubmodelBC](pt01ch09pyo41.md#ker-submodelbc-submodelbc-pyc) method, except for the *name* and *createStepName* arguments.
