...
ConcCharge 对象存储集中电荷的数据。

ConcCharge 对象派生自 [Load](pt01ch27pyo01.md) 对象。
...
此方法修改创建载荷的步骤中现有 ConcCharge 对象的数据。
...
`setValues` 的可选参数与 [ConcCharge](pt01ch27pyo15.md#ker-conccharge-conccharge-pyc) 方法的参数相同，但 *name* 和 *createStepName* 参数除外。
...
此方法修改指定步骤中现有 ConcCharge 对象的传播数据。
