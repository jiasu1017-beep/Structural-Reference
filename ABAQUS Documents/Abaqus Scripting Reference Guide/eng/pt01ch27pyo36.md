...
The InertiaRelief object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [InertiaRelief](pt01ch27pyo36.md#ker-inertiarelief-inertiarelief-pyc) method, except for the *name* and *createStepName* arguments.
