...
![](../graphics/stm_eqn06705.gif)![](../graphics/stm_eqn06978.gif)中![](../graphics/stm_eqn06979.gif)Green应变，![](../graphics/stm_eqn06980.gif)右Cauchy-Green应变张量，![](../graphics/stm_eqn00319.gif)变形梯度，![](../graphics/stm_eqn00064.gif)单位矩阵。在不丧失一般性的情况下，应变能函数可以写为形式
![](../graphics/stm_eqn06706.gif)
![](../graphics/stm_eqn06706.gif)![](../graphics/stm_eqn06981.gif)中![](../graphics/stm_eqn06982.gif)修正Green应变张量，![](../graphics/stm_eqn06983.gif)右Cauchy-Green应变的畸变部分，![](../graphics/stm_eqn06984.gif)体积变化。
...
![](../graphics/stm_eqn02953.gif)从[公式4.6.3-1](04s06a125.md)，![](../graphics/stm_eqn06985.gif)变分给出为

![](../graphics/stm_eqn06708.gif)![](../graphics/stm_eqn06986.gif)用虚功原理，应变能势的变分可以写为

![](../graphics/stm_eqn06709.gif)![](../graphics/stm_eqn00064.gif)![](../graphics/stm_eqn06987.gif)见[公式4.6.1-7](04s06a123.md)）。
...
利用纤维增强复合材料的连续体理论（Spencer，[1984](07s01a01-References.md)），应变能函数可以直接用变形张量和纤维方向的不变量表示。例如，考虑由![](../graphics/stm_eqn06990.gif)纤维增强的各向同性超弹性矩阵组成的复合材料。参考构型中纤维的方向由一组单位向量![](../graphics/stm_eqn06991.gif)征（，![](../graphics/stm_eqn06992.gif)。假设应变能不仅依赖于变形，还依赖于纤维方向，提出以下形式：
![](../graphics/stm_eqn06717.gif)
![](../graphics/stm_eqn06993.gif)料的应变能必须在参考构型中矩阵和纤维都经历刚体旋转时保持不变。然后，遵循Spencer（[1984](07s01a01-References.md)），应变能可以表达为张量![](../graphics/stm_eqn00162.gif)向量![](../graphics/stm_eqn06991.gif)不变量不可约标量集合的各向同性函数：
![](../graphics/stm_eqn06718.gif)
![](../graphics/stm_eqn06994.gif)中![](../graphics/stm_eqn06995.gif)![](../graphics/stm_eqn06996.gif)第一和第二偏应变不变量；![](../graphics/stm_eqn02113.gif)体积比（或第三应变不变量）；且![](../graphics/stm_eqn06997.gif)![](../graphics/stm_eqn06998.gif)![](../graphics/stm_eqn06999.gif)![](../graphics/stm_eqn06991.gif)![](../graphics/stm_eqn07000.gif)*伪不变量*，定义为
![](../graphics/stm_eqn03092.gif)
![](../graphics/stm_eqn07001.gif)![](../graphics/stm_eqn07002.gif)几何常数（独立于变形），等于参考构型中任意两族纤维方向之间夹角的余弦，
...
![](../graphics/stm_eqn06732.gif)从[公式4.6.3-4](04s06a125.md)，![](../graphics/stm_eqn06985.gif)变分给出为
...
![](../graphics/stm_eqn07005.gif)
![](../graphics/stm_eqn06724.gif)
![](../graphics/stm_eqn07006.gif)中![](../graphics/stm_eqn07007.gif)![](../graphics/stm_eqn07008.gif)
...
![](../graphics/stm_eqn07009.gif)中*U*是单位参考体积的应变能，*c*和*D*是温度依赖的材料参数，![](../graphics/stm_eqn07010.gif)弹性体积比，![](../graphics/stm_eqn07011.gif)义为
![](../graphics/stm_eqn06730.gif)
![](../graphics/stm_eqn07012.gif)中![](../graphics/stm_eqn07013.gif)各向异性材料常数的无量纲对称四阶张量，可以是温度依赖的，![](../graphics/stm_eqn07014.gif)修正Green应变张量的分量。
![](../graphics/stm_eqn06713.gif)![](../graphics/stm_eqn06714.gif)
弹性体积比，![](../graphics/stm_eqn07010.gif)将总体积比*J*和热体积比![](../graphics/stm_eqn06731.gif)
![](../graphics/stm_eqn06755.gif)![](../graphics/stm_eqn06756.gif)![](../graphics/stm_eqn07016)![](../graphics/stm_eqn07015.gif)
![](../graphics/stm_eqn06732.gif)
![](../graphics/stm_eqn07017.gif)出，其中![](../graphics/stm_eqn06733.gif)
初始偏量弹性张量，![](../graphics/stm_eqn06734.gif)
![](../graphics/stm_eqn07021)
![](../graphics/stm_eqn06735.gif)
Abaqus支持广义Fung模型的两种形式：各向异性和正交各向异性。必须指定的独立分量![](../graphics/stm_eqn07013.gif)数量取决于材料的各向异性程度：对于完全各向异性情况为21，对于正交各向异性情况为9。
