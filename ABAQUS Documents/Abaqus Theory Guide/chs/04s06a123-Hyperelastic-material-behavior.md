...
![](../graphics/stm_eqn06978)其中![](../graphics/stm_eqn06979)是Green应变，![](../graphics/stm_eqn06980)是右Cauchy-Green应变张量，![](../graphics/stm_eqn00319)是变形梯度，![](../graphics/stm_eqn00064)是单位矩阵。在不丧失一般性的情况下，应变能函数可以写为形式

![](../graphics/stm_eqn06981)其中![](../graphics/stm_eqn06982)是修正Green应变张量，![](../graphics/stm_eqn06983)是右Cauchy-Green应变的畸变部分，![](../graphics/stm_eqn06984)是体积变化。

基于应变的公式模型中的基本假设是优选材料方向最初在参考（无应力）构型中与正交坐标系对齐。这些方向只有在变形后才可能变得非正交。这种应变能函数形式的例子包括广义Fung型形式（见下文"广义Fung形式"）。

从[公式4.6.3-1](04s06a125.md)，![](../graphics/stm_eqn06985)的变分给出为

![](../graphics/stm_eqn06986)使用虚功原理，应变能势的变分可以写为

![](../graphics/stm_eqn06987)（见[公式4.6.1-7](04s06a123.md)）。

对于可压缩材料，应变变分是任意的，因此此方程定义此类材料的应力分量为

![](../graphics/stm_eqn06988)和

![](../graphics/stm_eqn06989)
...
从[公式4.6.3-4](04s06a125.md)，![](../graphics/stm_eqn06985)的变分给出为
...
![](../graphics/stm_eqn07016)![](../graphics/stm_eqn07015)由
