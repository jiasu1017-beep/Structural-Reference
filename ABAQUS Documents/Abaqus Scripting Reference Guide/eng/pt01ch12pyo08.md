...
The ConnectorLock object is derived from the [ConnectorBehaviorOption](pt01ch12pyo01.md) object.
...
### 12.8.1 ConnectorLock(...)

This method creates a connector lock behavior option for a [ConnectorSection](pt01ch46pyo08.md).
...
The optional arguments to `setValues` are the same as the arguments to the [ConnectorLock](pt01ch12pyo08.md#ker-connectorlock-connectorlock-pyc) method.
...
The ConnectorLock object has members with the same names and descriptions as the arguments to the [ConnectorLock](pt01ch12pyo08.md#ker-connectorlock-connectorlock-pyc) method.

### 12.8.4 Corresponding analysis keywords
