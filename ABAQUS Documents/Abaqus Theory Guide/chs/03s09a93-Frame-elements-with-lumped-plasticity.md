...
![](../graphics/stm_eqn05260.gif)使用[公式3.9.2-8](03s09a93-Frame-elements-with-lumped-plasticity.md)在[公式3.9.2-7](03s09a93-Frame-elements-with-lumped-plasticity.md)中，我们可以通过四元数提取来求解![](../graphics/stm_eqn05259.gif)。相对于参考单元坐标方向的分量
