...
This method adds a rendering command to the drawing and can be called multiple times to add additional rendering commands.  When the drawing is referenced by a [Viewport](pt01ch11pyo04.md), the drawing commands are used the render the Drawing.
...
A Float specifying the opacity for polygonal graphics primitives. Possible values are 0.0 ![](../graphics/ker_eqn00013.gif)                   *translucency*                   ![](../graphics/ker_eqn00013.gif)                   1.0 with 0.0 being completely transparent (invisible) and 1.0 being opaque.                 The default value is 1.0.
...
A Float specifying the width of the line, in millimeters, used to render edges. Possible values are 0.0 ![](../graphics/ker_eqn00013.gif)                   *lineSize*                   ![](../graphics/ker_eqn00013.gif)                   5.0 with 0.0 being interpreted as the thinnest possible line.                 The default value is 0.0.
...
A Float specifying the width of points, in millimeters, used to render points. Possible values are 0.0 ![](../graphics/ker_eqn00013.gif)                   *lineSize*                   ![](../graphics/ker_eqn00013.gif)                   5.0 with 0.0 being interpreted as the smallest possible point.                 The default value is 0.0.
...
The Drawing object has members with the same names and descriptions as the arguments to the [Drawing](pt01ch47pyo04.md#ker-drawing-drawing-pyc) method.
