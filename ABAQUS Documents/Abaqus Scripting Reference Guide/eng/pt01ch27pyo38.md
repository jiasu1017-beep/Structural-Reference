...
The InwardVolAccel object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [InwardVolAccel](pt01ch27pyo38.md#ker-inwardvolaccel-inwardvolaccel-pyc) method, except for the *name* and *createStepName* arguments.
