...
### *BIAXIAL TEST DATAUsed to provide biaxial test data (compression and/or tension).

This option is used to provide biaxial test data. It can be used only in conjunction with the [*HYPERELASTIC](ch08abk06.md) option, the [*HYPERFOAM](ch08abk07.md) option, and the [*MULLINS EFFECT](ch13abk31.md) option.
...
### **Optional parameter when the [*BIAXIAL TEST DATA](ch02abk09.md) option is used in conjunction with the [*HYPERELASTIC](ch08abk06.md), MARLOW option: **
