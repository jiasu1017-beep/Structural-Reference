# 47.7 MemoryReductionOptions object
...
The MemoryReductionOptions object has members with the same names and descriptions as the arguments to the [setValues](pt01ch47pyo07.md#ker-memoryreductionoptions-setvalues-pyc) method.
