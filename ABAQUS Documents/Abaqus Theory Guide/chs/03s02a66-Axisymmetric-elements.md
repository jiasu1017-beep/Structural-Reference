...
设![](../graphics/stm_eqn03061.gif)、![](../graphics/stm_eqn03062.gif)和![](../graphics/stm_eqn03063.gif)是点在未变形状态下沿径向、轴向和周向的单位向量，如图[图3.2.8-1](03s02a66-Axisymmetric-elements.md)所示。

图3.2.8-1 柱面坐标系和位置向量定义。

![](../graphics/stmcylsys.png)点的参考位置![](../graphics/stm_eqn00141.gif)可以用原始半径*R*和轴向位置*Z*表示：

![](../graphics/stm_eqn03064.gif)同样，设![](../graphics/stm_eqn03065.gif)、![](../graphics/stm_eqn03066.gif)和![](../graphics/stm_eqn03067.gif)是点在变形状态下沿径向、轴向和周向的单位向量。如[图3.2.8-1](03s02a66-Axisymmetric-elements.md)所示，径向和周向基向量依赖于![](../graphics/stm_eqn01111.gif)坐标：![](../graphics/stm_eqn03068.gif)和![](../graphics/stm_eqn03069.gif)。点的当前位置![](../graphics/stm_eqn00117.gif)可以用当前半径*r*和当前轴向位置*z*表示：
...
![](../graphics/stm_eqn03084.gif)当前位置![](../graphics/stm_eqn00117.gif)由[公式3.2.8-1](03s02a66-Axisymmetric-elements.md)给出，梯度算子可以用相对于柱面坐标的偏导数来描述：
...
![](../graphics/stm_eqn03089.gif)其中[公式3.2.8-2](03s02a66-Axisymmetric-elements.md)给出的运动被明确使用。
...
Abaqus用相对于轴对称扭转自由度的固定空间基来公式化有限元方程。因此，[公式3.2.8-4](03s02a66-Axisymmetric-elements.md)中![](../graphics/stm_eqn03094.gif)所需的结果不能简单地遵循[公式3.2.8-3](03s02a66-Axisymmetric-elements.md)的线性化得到。也就是说，有必要消除来自变分
...
![](../graphics/stm_eqn03108.gif)其中![](../graphics/stm_eqn03109.gif)与[公式3.2.8-5](03s02a66-Axisymmetric-elements.md)中![](../graphics/stm_eqn03110.gif)具有相同的形式。此外，在这个公式中![](../graphics/stm_eqn03111.gif)是非零的，可以利用"旋转变量，" 第1.3.1节证明![](../graphics/stm_eqn03112.gif)具有形式
