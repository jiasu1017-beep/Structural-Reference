...
This method creates an Image                     object from a given frame of an existing [Movie](pt01ch04pyo07.md)                     object.
...
The Image object has members with the same names and descriptions as the arguments to the [Image](pt01ch47pyo05.md#ker-image-image-pyc) method.
