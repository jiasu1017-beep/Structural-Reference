...
An Int (or stepIndex) specifying the step from which to obtain field output values. Possible values are 0 ![](../graphics/ker_eqn00013.gif) *step* ![](../graphics/ker_eqn00013.gif) (*numSteps*  1).

*frame*

An Int (or frameIndex) specifying the frame from which to obtain field output values. Possible values are 0 ![](../graphics/ker_eqn00013.gif) *frame* ![](../graphics/ker_eqn00013.gif) (*numFramesInStep*  1).
