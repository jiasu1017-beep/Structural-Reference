...
The VelocityAdaptiveMeshConstraint object is derived from the [AdaptiveMeshConstraint](pt01ch02pyo01.md) object.
...
A Float or a SymbolicConstant specifying the velocity component in the 1-direction. Possible values for the SymbolicConstant are UNSET and SET. The default value is UNSET.

**Note:**Although *v1*, *v2*, *v3*, *vr1*, *vr2*, and *vr3* are optional arguments, at least one of them must be specified.
...
The optional arguments to `setValues` are the same as the arguments to the [VelocityAdaptiveMeshConstraint](pt01ch02pyo13.md#ker-velocityadaptivemeshconstraint-velocityadaptivemeshc-pyc) method, except for the *name* and *createStepName* arguments.
