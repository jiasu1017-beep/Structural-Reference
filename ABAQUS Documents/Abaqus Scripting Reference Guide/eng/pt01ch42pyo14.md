...
The TemperatureState object stores the propagating data of a temperature in a step. One instance of this object is created internally by the [Temperature](pt01ch42pyo13.md) object for each step.

The TemperatureState object has no constructor or methods.

The TemperatureState object is derived from the [PredefinedFieldState](pt01ch42pyo12.md) object.
...
The SymbolicConstant UNSET or a String specifying the name of the amplitude reference. The SymbolicConstant UNSET should be used if the predefined field has no amplitude reference. The default value is UNSET.
...
A SymbolicConstant specifying the propagation state of the [PredefinedFieldState](pt01ch42pyo12.md) object. Possible values are:
- NOT_YET_ACTIVE
- CREATED
- PROPAGATED
- MODIFIED
...
This member exists in all [PredefinedFieldState](pt01ch42pyo12.md) objects, but different predefined fields use different subsets of the entire list of possible values depending on propagation rules.
