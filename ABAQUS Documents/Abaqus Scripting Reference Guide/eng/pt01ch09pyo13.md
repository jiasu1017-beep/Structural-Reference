# 9.13 ConnDisplacementBC object
...
The ConnDisplacementBC object is derived from the [BoundaryCondition](pt01ch09pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [ConnDisplacementBC](pt01ch09pyo13.md#ker-conndisplacementbc-conndisplacementbc-pyc) method, except for the *name* and *createStepName* arguments.
