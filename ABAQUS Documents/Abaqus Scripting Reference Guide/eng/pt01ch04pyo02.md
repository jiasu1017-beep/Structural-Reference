...
The AnimationOptions object is used to store values and attributes associated with an [AnimationController](pt01ch04pyo01.md) object. 

The AnimationOptions object has no constructor command. Abaqus creates the *animationOptions* member when it creates the [AnimationController](pt01ch04pyo01.md) object.
...
An Int specifying the animation rate in frames/second. Possible values are 1 ![](../graphics/ker_eqn00013.gif) *frameRate* ![](../graphics/ker_eqn00013.gif) 100. The default value is 50.
...
A SymbolicConstant specifying the relative scaling when the [AnimationController](pt01ch04pyo01.md) object's *animationType*=SCALE_FACTOR or HARMONIC. Possible values are FULL_CYCLE and HALF_CYCLE. The default value is HALF_CYCLE.

*numScaleFactorFrames*

An Int specifying the number of frames to be used when the [AnimationController](pt01ch04pyo01.md) object's *animationType*=SCALE_FACTOR or HARMONIC. The default value is 7.
