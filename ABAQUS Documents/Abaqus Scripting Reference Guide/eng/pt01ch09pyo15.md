...
The ConnVelocityBC object is derived from the [BoundaryCondition](pt01ch09pyo01.md) object.
...
A Float or a SymbolicConstant specifying the velocity component in the connector's local 1-direction. Possible values for the SymbolicConstant are UNSET and SET. The default value is UNSET.
...
The optional arguments to `setValues` are the same as the arguments to the [ConnVelocityBC](pt01ch09pyo15.md#ker-connvelocitybc-connvelocitybc-pyc) method, except for the *name* and *createStepName* arguments.
