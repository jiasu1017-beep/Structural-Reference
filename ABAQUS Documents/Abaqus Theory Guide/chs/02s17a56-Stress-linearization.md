...
![](../graphics/stm_eqn02726)其中
![](../graphics/stm_eqn02727.gif)
![](../graphics/stm_eqn02727)是应力值，

*t*是截面厚度，
![](../graphics/stm_eqn00794.gif)
![](../graphics/stm_eqn00794)是沿路径的应力，

*x*是沿路径的坐标。应力分量的线性弯曲值使用以下方程计算：
![](../graphics/stm_eqn02728.gif)![](../graphics/stm_eqn02729.gif)![](../graphics/stm_eqn02730.gif)
![](../graphics/stm_eqn02728)其中![](../graphics/stm_eqn02729)和![](../graphics/stm_eqn02730)是点A和点B（截面的端点；见图2.17.1-1）处的弯曲应力值。
...
![](../graphics/stm_eqn02731)和
![](../graphics/stm_eqn02732.gif)![](../graphics/stm_eqn02733.gif)
![](../graphics/stm_eqn02732)其中![](../graphics/stm_eqn02733)是沿路径点*j*处的应力。
### 轴对称结构
...
![](../graphics/stm_eqn02734)其中

![](../graphics/stm_eqn02735)是子午线方向的应力，
![](../graphics/stm_eqn02736.gif)![](../graphics/stm_eqn02737.gif)![](../graphics/stm_eqn02738.gif)
*R*是正在积分的点的半径，
![](../graphics/stm_eqn02739.gif)
![](../graphics/stm_eqn02736)是平均周向半径。子午线膜应力![](../graphics/stm_eqn02737)通过厚度除以获得：

![](../graphics/stm_eqn02739)
![](../graphics/stm_eqn02740.gif)
用于计算子午线膜应力的数值方案为
![](../graphics/stm_eqn02741.gif)
![](../graphics/stm_eqn02740)其中
![](../graphics/stm_eqn02742.gif)![](../graphics/stm_eqn02743.gif)
![](../graphics/stm_eqn02741)是沿路径点*j*处的子午线应力分量，
![](../graphics/stm_eqn02744.gif)![](../graphics/stm_eqn00155.gif)
![](../graphics/stm_eqn02742)是沿路径点*j*处的半径。为了计算子午线弯曲应力，我们首先需要计算从中面到子午线弯曲中性面的距离。该距离![](../graphics/stm_eqn02743等于

![](../graphics/stm_eqn02744)其中![](../graphics/stm_eqn00155是厚度方向和径向方向之间的角度。
![](../graphics/stm_eqn02745.gif)
每单位周向长度的子午线弯矩定义为
![](../graphics/stm_eqn02746.gif)
![](../graphics/stm_eqn02745)子午线弯曲的惯性矩为

![](../graphics/stm_eqn02746)
![](../graphics/stm_eqn02747.gif)
因此，端点A和B处的子午线弯曲应力通过以下获得
![](../graphics/stm_eqn02748.gif)
![](../graphics/stm_eqn02747)用于计算子午线弯矩的数值方案为
![](../graphics/stm_eqn02749.gif)
![](../graphics/stm_eqn02748)
![](../graphics/stm_eqn02750.gif)### 环向应力

![](../graphics/stm_eqn02751.gif)环向膜应力![](../graphics/stm_eqn02749)通过以下获得

![](../graphics/stm_eqn00593.gif)![](../graphics/stm_eqn02750)其中

![](../graphics/stm_eqn02752.gif)![](../graphics/stm_eqn02751)是环向应力，

![](../graphics/stm_eqn02753.gif)![](../graphics/stm_eqn00593是子午线平面中截面中面的曲率半径。端点处的环向弯曲应力使用以下关系获得

![](../graphics/stm_eqn02754.gif)![](../graphics/stm_eqn02752)其中

![](../graphics/stm_eqn02755.gif)![](../graphics/stm_eqn02753)是中面到环向弯曲中性面的距离，

![](../graphics/stm_eqn02754)是每单位子午线长度的环向弯矩，

![](../graphics/stm_eqn02756.gif)![](../graphics/stm_eqn02755是环向弯曲的惯性矩。

![](../graphics/stm_eqn02757.gif)计算周向膜应力的数值方案为

![](../graphics/stm_eqn02756)弯矩通过求和计算
...
![](../graphics/stm_eqn02758)我们选择厚度"弯曲"应力，使得端点A和B处厚度膜应力和弯曲应力的和等于这些点的总应力：
![](../graphics/stm_eqn02760.gif)![](../graphics/stm_eqn02761.gif)
![](../graphics/stm_eqn02759)并在线性插值这些值之间的弯曲应力。这是合理的假设，因为厚度表面应力由施加的压力决定，不应有强烈的"峰值"应力贡献。
### 剪切应力

![](../graphics/stm_eqn02762.gif)子午线平面中的膜剪切应力以与子午线膜应力相同的方式计算：

![](../graphics/stm_eqn02760)其中![](../graphics/stm_eqn02761)是沿路径的剪切应力。
...
点之间的向量（![](../graphics/stm_eqn02764)、![](../graphics/stm_eqn02765)、![](../graphics/stm_eqn02766)和（![](../graphics/stm_eqn02767)、![](../graphics/stm_eqn02768)、![](../graphics/stm_eqn02769)为

![](../graphics/stm_eqn02770)假设局部*y*轴位于局部*x*轴和全局*Y*轴的平面内，局部*z*轴定义为

![](../graphics/stm_eqn02771)因此，局部*y*轴将为

![](../graphics/stm_eqn02772)归一化后，以上三个向量可以组合创建变换矩阵。
### 参考
