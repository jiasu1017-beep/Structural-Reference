...
The Temperature object is derived from the [PredefinedField](pt01ch42pyo01.md) object.
...
A String specifying the name of the [AnalyticalField](pt01ch21pyo02.md) or [DiscreteField](pt01ch21pyo04.md) object associated with this predefined field. The *field* argument applies only when *distributionType*=FIELD or *distributionType*=DISCRETE_FIELD. The default value is an empty string.
...
This method moves the [TemperatureState](pt01ch42pyo14.md) object from one step to a different step.

**Required arguments**

*fromStepName*

A String specifying the name of the step from which the [PredefinedFieldState](pt01ch42pyo12.md) is moved.

*toStepName*

A String specifying the name of the step to which the [PredefinedFieldState](pt01ch42pyo12.md) is moved.
...
The optional arguments to `setValues` are the same as the arguments to the [Temperature](pt01ch42pyo13.md#ker-temperature-temperature-pyc) method, except for the *name* and *createStepName* arguments.
...
The optional arguments to `setValuesInStep` are the same as the optional arguments to the [Temperature](pt01ch42pyo13.md#ker-temperature-temperature-pyc) method, except for the *distributionType* and *crossSectionDistribution* arguments.
None.
...
### 42.13.6 Corresponding analysis keywords
