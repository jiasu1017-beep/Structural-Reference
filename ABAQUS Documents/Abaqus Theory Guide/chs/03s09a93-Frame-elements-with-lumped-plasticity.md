...
![](../graphics/stm_eqn04525.gif)![](../graphics/stm_eqn05177.gif)![](../graphics/stm_eqn05178.gif)**产品：** Abaqus/Standard
...
![](../graphics/stm_eqn05268.gif)遵循Euler-Bernoulli梁理论的广义应变为
...
![](../graphics/stm_eqn05223.gif)![](../graphics/stm_eqn05224.gif)和![](../graphics/stm_eqn05225.gif)是第*i*个塑性分量的截面参数，必须从定义截面硬化响应的测试数据中校准。参数![](../graphics/stm_eqn05224.gif)是初始运动硬化模量，参数![](../graphics/stm_eqn05225.gif)决定了运动硬化模量随塑性变形增加而减小的速率。此实现所需的测试数据是截面力和弯矩分量作为广义塑性位移函数的 值。这些要么是轴向力对塑性轴向位移，要么是弯矩对铰塑性旋转。数据可以给定为值对——广义截面力对共轭广义塑性位移——或者通过指定截面的屈服应力。曲线拟合算法将确定每个分量*i*的参数![](../graphics/stm_eqn05224.gif)和![](../graphics/stm_eqn05225.gif)，因为硬化律为每个截面力分量![](../graphics/stm_eqn05226.gif)单独写出，*i*的范围取决于进入塑性交互面的力和力矩的数量。积分硬化规则[公式3.9.2-1](03s09a93-Frame-elements-with-lumped-plasticity.md)，获得背应力的以下演化律：
...
![](../graphics/stm_eqn05216.gif)![](../graphics/stm_eqn05215.gif)![](../graphics/stm_eqn05214.gif)![](../graphics/stm_eqn05260.gif)使用[公式3.9.2-8](03s09a93-Frame-elements-with-lumped-plasticity.md)在[公式3.9.2-7](03s09a93-Frame-elements-with-lumped-plasticity.md)中，我们可以通过四元数提取来求解![](../graphics/stm_eqn05259.gif)。相对于参考单元坐标方向的分量
...
![](../graphics/stm_eqn05270.gif)其中![](../graphics/stm_eqn05271.gif)表示塑性变形开始时塑性方向的分量*i*。对于[公式3.9.2-2](03s09a93-Frame-elements-with-lumped-plasticity.md)形式的塑性交互面，缩放因子等于![](../graphics/stm_eqn05272.gif)。

图3.9.2-2 框架单元的硬化模型。

![](../graphics/stm_eqn00904.gif)![](../graphics/stmframehardening.png)
### 参考

### 参考

![](../graphics/stm_eqn03734.gif)![](../graphics/stm_eqn05195.gif)![](../graphics/stm_eqn05196.gif)![](../graphics/stm_eqn05194.gif)![](../graphics/stm_eqn03733.gif)![](../graphics/stm_eqn05184.gif)![](../graphics/stm_eqn05185.gif)![](../graphics/stm_eqn02599.gif)![](../graphics/stm_eqn05182.gif)"Frame elements," Section 29.4 of the Abaqus Analysis User's Guide
