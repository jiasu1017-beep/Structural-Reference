...
Chebyshev2Filter 对象定义 Chebyshev 2 类过滤器。

Chebyshev2Filter 对象派生自 [Filter](pt02ch59pyo01.md) 对象。
...
一个 Double，指定过滤器中允许的纹波量。可能的值为小于 1 的非负数。默认值为 0.025。
...
`setValues` 的可选参数与 [Chebyshev2Filter](pt02ch59pyo04.md#ker-chebyshev2filter-chebyshev2filter-cpp) 方法的参数相同，但 *name* 参数除外。
...
Chebyshev2Filter 对象具有与 [Chebyshev2Filter](pt02ch59pyo04.md#ker-chebyshev2filter-chebyshev2filter-cpp) 方法的参数具有相同名称和描述的成员。
