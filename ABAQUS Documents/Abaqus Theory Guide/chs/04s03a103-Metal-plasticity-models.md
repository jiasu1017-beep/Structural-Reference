...
![](../graphics/stm_eqn05594.gif)其中![](../graphics/stm_eqn05595.gif)等效塑性应变率；![](../graphics/stm_eqn05596.gif) nonzero塑性应变率时的屈服应力；![](../graphics/stm_eqn05597.gif)静屈服应力（可能依赖于塑性应变——![](../graphics/stm_eqn05598.gif)—通过各向同性硬化，依赖于温度——![](../graphics/stm_eqn01111.gif)—以及其他场变量，![](../graphics/stm_eqn01501.gif)；![](../graphics/stm_eqn05599.gif)![](../graphics/stm_eqn05600.gif)材料参数，可以是温度的函数，也可能是其他预定状态变量的函数。另一种方式是定义屈服应力比，![](../graphics/stm_eqn05601.gif)作为等效塑性应变率![](../graphics/stm_eqn05595.gif)函数。这两个选项都假设不同应变率下的硬化曲线形状相同。如果不同应变率下硬化曲线的形状不同，可以直接指定静态和率相关应力-应变关系。给定应变率下的屈服应力直接从这些关系插值。最后，用户可以通过用户子程序UHARD描述一般的率相关各向同性硬化。见[Symonds（1967）](07s01a01-References.md)、[Lindholm和Besseny（1969）](07s01a01-References.md)以及[Eleiche（1972）](07s01a01-References.md)获取高应变率相关材料响应测量的集合或此类测量的文献目录。
...
![](../graphics/stm_eqn05602.gif)其中![](../graphics/stm_eqn05285.gif)等效（单轴）应力，![](../graphics/stm_eqn05603.gif)功等效塑性应变，定义为

![](../graphics/stm_eqn05604.gif)且![](../graphics/stm_eqn01111.gif)温度。
