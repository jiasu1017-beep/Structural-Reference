...
![](../graphics/stm_eqn02182.gif)其中![](../graphics/stm_eqn00178)是电通量向量；![](../graphics/stm_eqn02183)是单位面积的电通量，从物体表面一点进入身体；![](../graphics/stm_eqn02184)是单位体积进入身体的电通量；以及![](../graphics/stm_eqn02185)，其中![](../graphics/stm_eqn02186)是任意连续标量场（虚电位）。这些量也以其他术语知道，这些术语在电气工程参考文献中经常使用。电通量向量*q*称为电位移，电位梯度*E*称为电场。
### 本构行为：材料耦合
...
![](../graphics/stm_eqn02204.gif)这些用压电应力系数矩阵![](../graphics/stm_eqn02205)表示。然而，Abaqus也允许输入以压电应变系数矩阵![](../graphics/stm_eqn02206)表示的压电常数。
...
![](../graphics/stm_eqn02210.gif)其中![](../graphics/stm_eqn02211)是插值函数数组，![](../graphics/stm_eqn02212)和![](../graphics/stm_eqn02213)是节点量。体力、电荷以及表面力和电荷以类似方式插值。

应变和电位梯度给出为

![](../graphics/stm_eqn02214.gif)和

![](../graphics/stm_eqn02215.gif)其中![](../graphics/stm_eqn02216)和![](../graphics/stm_eqn02217)是![](../graphics/stm_eqn02211的空间导数。在几何非线性分析中，这些空间导数在当前配置中定义。
### 系统方程

利用这些近似场和上述本构特性，结合平衡和守恒方程，导出以下关于节点量的方程组：

![](../graphics/stm_eqn02218.gif)和
