# 27.67 SurfaceCurrentDensity object
...
The SurfaceCurrentDensity object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [SurfaceCurrentDensity](pt01ch27pyo67.md#ker-surfacecurrentdensity-surfacecurrentdensity-pyc) method, except for the *name* and *createStepName* arguments.
