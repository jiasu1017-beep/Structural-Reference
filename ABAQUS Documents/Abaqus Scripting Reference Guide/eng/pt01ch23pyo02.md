# 23.2 FreeBodyReportOptions object
...
The FreeBodyReportOptions object has members with the same names and descriptions as the arguments to the [setValues](pt01ch23pyo02.md#ker-freebodyreportoptions-setvalues-pyc) method.
