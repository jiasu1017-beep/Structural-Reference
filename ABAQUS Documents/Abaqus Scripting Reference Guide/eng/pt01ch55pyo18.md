...
The following commands operate on Session objects. For more information about the Session object, see ["Session object," Section 47.1](pt01ch47pyo01.md).
...
A[Path](pt01ch39pyo01.md)                              object specifying the end points of the stress line.
...
A Float specifying the in-plane radius of curvature of the center section along the stress line for axi-symmetric models. The default value is ![](../graphics/ker_eqn00427.gif).
...
A Boolean specifying whether to create a [Path](pt01ch39pyo01.md)                                object containing all the points used when performing the linearized stress computation. The default value is OFF                              . When this argument is set to ON                              , a [Path](pt01ch39pyo01.md)                                object is created with the same name as that of the stress line and placed in the `Path`                                repository.
...
### 55.18.2 setPathTolerance(...)

This method is used to set the *tolerance*                       to be used when creating [XYData](pt01ch55pyo01.md)                       objects by extracting results along [Path](pt01ch39pyo01.md)                       objects. This command should be exercised with caution since setting a value too low or too high may result in getting no results or unpredictable results.
...
### 55.18.3 getPathTolerance()

This method is used to get the *tolerance*                       used when creating [XYData](pt01ch55pyo01.md)                       objects by extracting results along [Path](pt01ch39pyo01.md)                       objects.
...
### 55.18.4 setLimitForXYDataPlots(...)

This method is used to set the *limit*                       for number of XY data objects while creating [XYData](pt01ch55pyo01.md)                        from field output.
...
### 55.18.5 getLimitForXYDataPlots()

This method is used to get the *limit*                       for number of XY data objects while creating [XYData](pt01ch55pyo01.md) from field output.
