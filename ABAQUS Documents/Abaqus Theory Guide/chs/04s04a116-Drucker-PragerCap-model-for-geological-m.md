...
如上所述，帽面随着体积塑性应变和体积蠕变应变硬化或软化：体积非弹性压实（当在帽上屈服或通过固结机制蠕变时）导致硬化，而体积塑性膨胀（当在剪切破坏面上屈服或通过内聚机制蠕变时）导致软化。两个屈服面之间的分离和两个蠕变机制的主要区域由演化参数定义，![](../graphics/stm_eqn06232.gif)它与用户定义的静水压缩屈服应力，![](../graphics/stm_eqn06244（[图4.4.4-3](04s04a116.md)）相关。
