...
Many metals have approximately linear elastic behavior at low strain magnitudes (see [Figure 10–1](#gss-stress-strain)), and the stiffness of the material, known as the Young's or elastic modulus, is constant.
...
At higher stress (and strain) magnitudes, metals begin to have nonlinear, inelastic behavior (see [Figure 10–2](#gss-nominal)), which is referred to as plasticity.
...
The stiffness of a metal typically decreases dramatically once the material yields (see [Figure 10–2](#gss-nominal)). A ductile metal that has yielded will recover its initial elastic stiffness when the applied load is removed (see [Figure 10–2](#gss-nominal)). Often the plastic deformation of the material increases its yield stress for subsequent loadings: this behavior is called work hardening.
...
The strains provided in material test data used to define the plastic behavior are not likely to be the plastic strains in the material. Instead, they will probably be the total strains in the material. You must decompose these total strain values into the elastic and plastic strain components. The plastic strain is obtained by subtracting the elastic strain, defined as the value of true stress divided by the Young's modulus, from the value of total strain (see [Figure 10–3](#gss-total-strain)).
...
![](../graphics/gsa_eqn00226.gif)

where

![](../graphics/gsa_eqn00227.gif):

is true plastic strain,

![](../graphics/gsa_eqn00228.gif):

is true total strain,

![](../graphics/gsa_eqn00229.gif):

is true elastic strain,

![](../graphics/gsa_eqn00230.gif):
