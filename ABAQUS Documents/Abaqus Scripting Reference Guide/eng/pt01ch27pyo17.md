...
The ConcCurrent object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [ConcCurrent](pt01ch27pyo17.md#ker-conccurrent-conccurrent-pyc) method, except for the *name* and *createStepName* arguments.
