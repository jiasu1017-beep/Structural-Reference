...
The QuantityType object is used to store attributes defining the physical dimension and label of the quantity type to be associated with an [XYData](pt01ch55pyo01.md) or an [AxisData](pt01ch55pyo05.md) object.

 QuantityType objects are automatically created when creating [XYData](pt01ch55pyo01.md) objects from the odb. 
...
The QuantityType object has members with the same names and descriptions as the arguments to the [setValues](pt01ch55pyo11.md#ker-quantitytype-setvalues-pyc) method.
