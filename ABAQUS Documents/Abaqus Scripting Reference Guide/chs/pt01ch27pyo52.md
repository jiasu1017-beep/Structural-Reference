...
The PressureState object stores the propagating data for a pressure in a step. One instance of this object is created internally by the [Pressure](pt01ch27pyo51.md) object for each step. The instance is also deleted internally by the [Pressure](pt01ch27pyo51.md) object.

The PressureState object has no constructor or methods.

The PressureState object is derived from the [LoadState](pt01ch27pyo42.md) object.
...
### 27.52.2 Corresponding analysis keywords
