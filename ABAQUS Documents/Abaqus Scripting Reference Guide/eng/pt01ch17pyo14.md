# 17.14 MeshDisplayOptions object
...
A Float specifying the angle in degrees to be used in calculating a feature edge plot. Possible values are 0 ![](../graphics/ker_eqn00013.gif) *featureAngle* ![](../graphics/ker_eqn00013.gif) 90. The default value is 20.0.
...
The MeshDisplayOptions object has members with the same names and descriptions as the arguments to the [setValues](pt01ch17pyo14.md#ker-meshdisplayoptions-setvalues-pyc) method.
