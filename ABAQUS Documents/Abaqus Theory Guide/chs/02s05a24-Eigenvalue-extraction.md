...
Householder 算法产生一个对称三对角矩阵，它具有与原始矩阵相同的特征值，因为变换（[方程 2.5.1-6](02s05a24-Eigenvalue-extraction.md)）不改变特征值。
...
Abaqus/Standard 提供子空间投影方法用于求解原始特征值问题（[方程 2.5.1-1](02s05a24-Eigenvalue-extraction.md)）的复特征值和右特征向量。子空间投影方法
