...
The MappedField object is derived from the [AnalyticalField](pt01ch21pyo02.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [MappedField](pt01ch21pyo06.md#ker-mappedfield-mappedfield-pyc) method, except for the *name* argument.
...
An [OdbMeshRegionData](pt01ch21pyo07.md) object specifying the external source data from ODB mesh region.
