# 25.54 PressurePenetration object
...
The PressurePenetration object is derived from the [Interaction](pt01ch25pyo01.md) object.
...
A [RegionArray](pt01ch45pyo03.md) object specifying the points on the master surface that are exposed to the fluid.

*slavePoints*

A [RegionArray](pt01ch45pyo03.md) object specifying the points on the slave surface that are exposed to the fluid.
...
The optional arguments to `setValues` are the same as the arguments to the [PressurePenetration](pt01ch25pyo54.md#ker-pressurepenetration-pressurepenetration-pyc) method, except for the *name* and *createStepName* arguments.
...
### 25.54.5 Corresponding analysis keywords
