...
The SubstructureLoad object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [SubstructureLoad](pt01ch27pyo60.md#ker-substructureload-substructureload-pyc) method, except for the *name* and *createStepName* arguments.
