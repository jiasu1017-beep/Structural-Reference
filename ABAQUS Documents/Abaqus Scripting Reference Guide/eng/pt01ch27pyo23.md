# 27.23 ConcentratedHeatFlux object
...
The ConcentratedHeatFlux object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [ConcentratedHeatFlux](pt01ch27pyo23.md#ker-concentratedheatflux-concentratedheatflux-pyc) method, except for the *name* and *createStepName* arguments.
