...
The Axis object is used to store the display attributes of axes. Axes objects are automatically created when adding [XYCurve](pt01ch55pyo15.md) objects to a [Chart](pt01ch55pyo06.md) object.
...
A [TextStyle](pt01ch55pyo13.md) object specifying  the text properties to be used when displaying axis labels.

*lineStyle*

A [LineStyle](pt01ch55pyo10.md) object specifying the line properties used to display the axis.
...
A [LineStyle](pt01ch55pyo10.md) object specifying  the line properties to be used when displaying axis ticks.

*titleStyle*

A [TextStyle](pt01ch55pyo13.md) object specifying  the text properties to be used when displaying the axis title.
...
An [AxisData](pt01ch55pyo05.md) object specifying the numerical data of the axis.
