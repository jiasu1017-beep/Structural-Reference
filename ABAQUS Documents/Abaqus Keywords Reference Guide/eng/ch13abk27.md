...
### *MOMENTUM EQUATION SOLVERSpecify the linear solver and parameters for solving the momentum equations in an Abaqus/CFD analysis.

This option can be used only as a suboption of the [*CFD](ch03abk13.md) option to enable the linear solver parameters for solving the momentum equations. For a steady-state analysis this option is also used to enable the under-relaxation parameter for the nonlinear momentum solver.
