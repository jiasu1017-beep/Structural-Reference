...
An Int or the SymbolicConstant UNLIMITED specifying the maximum number of elements of a sequence to return. Possible values are UNLIMITED or Ints ![](../graphics/ker_eqn00060.gif) 0. The initial value is 100. After the maximum number of elements, the remainder are indicated by the string '...'.
...
The TextReprOptions object has members with the same names and descriptions as the arguments to the [setValues](pt01ch52pyo03.md#ker-txt-textrepop-setvalues-pyc) method.
