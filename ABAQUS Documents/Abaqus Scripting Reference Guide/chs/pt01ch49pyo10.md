...
The EmagTimeHarmonicStep object is derived from the [AnalysisStep](pt01ch49pyo02.md) object.
...
An [EmagTimeHarmonicFrequencyArray](pt01ch50pyo08.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [EmagTimeHarmonicStep](pt01ch49pyo10.md#ker-emagtimeharmonicstep-emagtimeharmonicstep-pyc) method, except for the *name* argument.
...
The EmagTimeHarmonicStep object has members with the same names and descriptions as the arguments to the [EmagTimeHarmonicStep](pt01ch49pyo10.md#ker-emagtimeharmonicstep-emagtimeharmonicstep-pyc) method.
