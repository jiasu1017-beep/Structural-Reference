# 22.4 Chebyshev2Filter 对象





Chebyshev2Filter 对象定义 Chebyshev 2 型滤波器。

Chebyshev2Filter 对象派生自 [Filter](pt01ch22pyo01.md) 对象。
...
一个 Float，指定滤波器中允许的波纹量。可能的值为小于 1 的非负数。默认值为 0.025。
...
`setValues` 的可选参数与 [Chebyshev2Filter](pt01ch22pyo04.md#ker-chebyshev2filter-chebyshev2filter-pyc) 方法的参数相同，但 *name* 参数除外。
...
Chebyshev2Filter 对象具有与 [Chebyshev2Filter](pt01ch22pyo04.md#ker-chebyshev2filter-chebyshev2filter-pyc) 方法的参数相同的名称和描述的成员。
