# 27.8 BodyCurrentState 对象





BodyCurrentState 对象存储体电流在某个步骤中的传播数据。该对象的实例由 [BodyCurrent](pt01ch27pyo06.md) 对象为每个步骤内部创建。该实例也由 [BodyCurrent](pt01ch27pyo06.md) 对象内部删除。

BodyCurrentState 对象没有构造函数或方法。

BodyCurrentState 对象派生自 [LoadState](pt01ch27pyo42.md) 对象。
