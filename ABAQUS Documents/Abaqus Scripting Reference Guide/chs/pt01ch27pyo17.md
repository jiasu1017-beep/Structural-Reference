# 27.17 ConcCurrent 对象





ConcCurrent 对象存储集中电流的数据。

ConcCurrent 对象派生自 [Load](pt01ch27pyo01.md) 对象。
...
此方法修改创建载荷的步骤中现有 ConcCurrent 对象的数据。
...
`setValues` 的可选参数与 [ConcCurrent](pt01ch27pyo17.md#ker-conccurrent-conccurrent-pyc) 方法的参数相同，但 *name* 和 *createStepName* 参数除外。
...
### 27.17.3 setValuesInStep(...)

此方法修改指定步骤中现有 ConcCurrent 对象的传播数据。
