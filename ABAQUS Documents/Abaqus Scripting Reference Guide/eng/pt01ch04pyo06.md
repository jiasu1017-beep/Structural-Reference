...
A pair of Ints specifying the width and height of the image in pixels when *sizeDefinition*=USER_DEFINED. Possible values are Ints in the range (*minWidth*, *minHeight*) ![](../graphics/ker_eqn00013.gif) (width, height) ![](../graphics/ker_eqn00013.gif) (*maxWidth*, *maxHeight*). The default value is the screen size.
...
The minimum width and height are normally < 50 pixels. The values of the maximum width (*maxWidth*) and height (*maxHeight*) depend on the graphics capabilities of the system.  The maximum width and height will be at least as large as the screen dimensions.
...
The QuickTimeOptions object has members with the same names and descriptions as the arguments to the [setValues](pt01ch04pyo06.md#ker-quicktimeoptions-setvalues-pyc) method.
