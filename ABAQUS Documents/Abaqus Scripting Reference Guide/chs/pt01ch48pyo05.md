# 48.5 ConstrainedSketchGeometry object
...
### 48.5.2 ArcByCenterEnds(...)

This method constructs an arc using a center point and two vertices. The Arc object is added to the geometry repository of the [ConstrainedSketch](pt01ch48pyo01.md)                     object. The arc is created in a clockwise fashion from *point1*                     to *point2*.
...
### 48.5.3 ArcByStartEndTangent(...)

This method constructs an arc using two vertices. The Arc object is added to the geometry repository of the [ConstrainedSketch](pt01ch48pyo01.md)                     object.
...
### 48.5.4 CircleByCenterPerimeter(...)

This method constructs a circle using a center point and a point on the perimeter. The circle is added to the geometry repository of the [ConstrainedSketch](pt01ch48pyo01.md)                     object.
...
### 48.5.5 ConstructionCircleByCenterPerimeter(...)

This method constructs a construction circle using a center point and a point on the perimeter. The circle is added to the geometry repository of the [ConstrainedSketch](pt01ch48pyo01.md)                     object.
...
### 48.5.6 EllipseByCenterPerimeter(...)

This method constructs an ellipse using a center point, a major axis point, and a minor axis point. The ellipse is added to the geometry repository of the [ConstrainedSketch](pt01ch48pyo01.md)                     object.
...
### 48.5.7 FilletByRadius(...)

This method constructs a fillet arc of a given radius between two curves. The fillet is added to the geometry repository of the [ConstrainedSketch](pt01ch48pyo01.md)                     object.
...
This method creates a spot construction point located at the specified coordinates. The spot is added to the vertex repository of the [ConstrainedSketch](pt01ch48pyo01.md)                     object.
...
This method returns an list of [ConstrainedSketchVertex](pt01ch48pyo10.md)                     objects which are a part of the given ConstrainedSketchGeometry                     object.
...
A list of [ConstrainedSketchVertex](pt01ch48pyo10.md)                     objects.
