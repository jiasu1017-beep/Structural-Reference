...
The ConcCharge object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [ConcCharge](pt01ch27pyo15.md#ker-conccharge-conccharge-pyc) method, except for the *name* and *createStepName* arguments.
