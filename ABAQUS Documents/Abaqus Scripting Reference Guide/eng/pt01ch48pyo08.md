# 48.8 ConstrainedSketchOptions object
...
A Float specifying the sheet size. Possible values are Floats ![](../graphics/ker_eqn00060.gif)                  0. The default value is the *sheetSize*                  specified with the `Sketch`                  method.

*gridSpacing*

A Float specifying the spacing between gridlines. Possible values are Floats ![](../graphics/ker_eqn00060.gif)                  0. The default value is approximately 2.5% of *sheetSize*.
...
An Int specifying how often gridlines are shown. Possible values are *gridFrequency*                   ![](../graphics/ker_eqn00060.gif) 0.                 The default value is 1.

*dimensionTextHeight*

A Float specifying the height of the dimension text in points. Possible values are Floats ![](../graphics/ker_eqn00060.gif) 0.                 The default value is 12.0.

*decimalPlaces*

An Int specifying how many decimal places are shown in dimensions. Possible values are 0 ![](../graphics/ker_eqn00013.gif)                   *decimalPlaces*                   ![](../graphics/ker_eqn00013.gif)                    6. The initial value depends on the value of *sheetSize*.
...
The ConstrainedSketchOptions object has members with the same names and descriptions as the arguments to the [setValues](pt01ch48pyo08.md#ker-constrainedsketchoptions-setvalues-pyc) method.
