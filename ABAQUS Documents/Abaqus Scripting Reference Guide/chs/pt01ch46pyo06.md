# 46.6 CompositeShellSection 对象

CompositeShellSection 对象定义复合壳截面的属性。

CompositeShellSection 对象派生自 [GeometryShellSection](pt01ch46pyo12.md) 对象。
...
此方法创建 CompositeShellSection 对象。
...
*layup*
 ...
 [SectionLayerArray](pt01ch46pyo20.md) 对象，指定壳截面。
...
此方法修改 CompositeShellSection 对象。
...
**可选参数**
 ...
 `setValues` 的可选参数与 [CompositeShellSection](pt01ch46pyo06.md#ker-compositeshellsection-compositeshellsection-pyc) 方法的参数相同，但 *name* 参数除外。
...
CompositeShellSection 对象的成员与 [CompositeShellSection](pt01ch46pyo06.md#ker-compositeshellsection-compositeshellsection-pyc) 方法的参数具有相同的名称和描述。

此外，CompositeShellSection 对象可以具有以下成员：
