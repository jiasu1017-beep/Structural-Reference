# 22.5 OperatorFilter 对象





OperatorFilter 对象定义算子滤波器。

OperatorFilter 对象派生自 [Filter](pt01ch22pyo01.md) 对象。
...
`setValues` 的可选参数与 [OperatorFilter](pt01ch22pyo05.md#ker-operatorfilter-operatorfilter-pyc) 方法的参数相同，但 *name* 参数除外。
...
OperatorFilter 对象具有与 [OperatorFilter](pt01ch22pyo05.md#ker-operatorfilter-operatorfilter-pyc) 方法的参数相同的名称和描述的成员。
