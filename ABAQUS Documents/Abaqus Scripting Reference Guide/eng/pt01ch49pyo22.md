...
The SoilsStep object is derived from the [AnalysisStep](pt01ch49pyo02.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [SoilsStep](pt01ch49pyo22.md#ker-soilsstep-soilsstep-pyc) method, except for the *name*, *previous*, and *maintainAttributes* arguments.
...
### 49.22.4 Corresponding analysis keywords
