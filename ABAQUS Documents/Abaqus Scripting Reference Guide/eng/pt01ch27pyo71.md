...
The SurfacePoreFluid object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [SurfacePoreFluid](pt01ch27pyo71.md#ker-surfaceporefluid-surfaceporefluid-pyc) method, except for the *name* and *createStepName* arguments.
