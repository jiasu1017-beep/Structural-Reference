...
![](../graphics/bmk_eqn01723.gif) 40 to 45 Hz
...
This is a test recommended by the National Agency for Finite Element Methods and Standards (U.K.): Test 5H from NAFEMS “Selected Benchmarks for Forced Vibration,” R0016, March 1993.
...
The results are shown in [Table 4.5.2--1](ch04s05anf27.md#table-test5h-modal) and [Table 4.5.2--2](ch04s05anf27.md#table-test5h-direct). The values enclosed in parentheses are percentage differences with respect to the reference solution.

**Table 4.5.2–1** Modal solution.
