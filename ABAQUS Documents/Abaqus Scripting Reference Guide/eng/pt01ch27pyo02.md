...
The BodyCharge object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [BodyCharge](pt01ch27pyo02.md#ker-bodycharge-bodycharge-pyc) method, except for the *name* and *createStepName* arguments.
