# 29.8 CapCreepCohesion 对象





CapCreepCohesion 对象指定帽盖蠕变模型和材料特性。
...
`setValues` 的可选参数与 [CapCreepCohesion](pt01ch29pyo08.md#ker-capcreepcohesion-capcreepcohesion-pyc) 方法的参数相同。
...
CapCreepCohesion 对象具有与 [CapCreepCohesion](pt01ch29pyo08.md#ker-capcreepcohesion-capcreepcohesion-pyc) 方法参数同名的成员，描述也相同。
