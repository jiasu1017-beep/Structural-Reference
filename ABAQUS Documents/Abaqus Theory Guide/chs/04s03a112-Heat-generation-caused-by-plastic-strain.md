...
![](../graphics/stm_eqn06045.gif)其中![](../graphics/stm_eqn00483.gif)是流动方向（我们假定![](../graphics/stm_eqn06046.gif)，其中![](../graphics/stm_eqn01111)是温度），且![](../graphics/stm_eqn05603)是塑性应变的标量测度，用作某些塑性模型中屈服面和流动势定义中的硬化参数。在这种情况下，我们仅考虑各向同性硬化理论：Abaqus仅为此类模型提供热-机械耦合。
...
![](../graphics/stm_eqn06053.gif)其中![](../graphics/stm_eqn00399)是总应变，![](../graphics/stm_eqn06054)是热膨胀引起的应变。在Abaqus的本构模型中![](../graphics/stm_eqn06055.gif) only。这种分解形式依赖于![](../graphics/stm_eqn00399)被测量为变形率的积分以及弹性和热应变很小：，这对于程序中提供的标准塑性模型是成立的。
...
![](../graphics/stm_eqn06057.gif)其中![](../graphics/stm_eqn06058)是标量应力函数（例如，简单金属塑性模型的Mises或Hill应力函数），且![](../graphics/stm_eqn06059)是率无关模型的屈服应力，而![](../graphics/stm_eqn06060)对于率相关模型，其中

![](../graphics/stm_eqn06061.gif)从增量上的平均塑性应变率定义率效应。例如，默认情况下，率相关塑性模型定义

![](../graphics/stm_eqn06062.gif)其中![](../graphics/stm_eqn05702)是Mises或Hill等效应力，且![](../graphics/stm_eqn05624)和![](../graphics/stm_eqn05625)是材料参数。在此表达式中使用增量上的平均塑性应变率定义
