...
The VelocityBC object is derived from the [BoundaryCondition](pt01ch09pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [VelocityBC](pt01ch09pyo49.md#ker-velocitybc-velocitybc-pyc) method, except for the *name* and *createStepName* arguments.
