...
![](../graphics/stm_eqn00720.gif)so that ![](../graphics/stm_eqn00721.gif) approaches ![](../graphics/stm_eqn00722.gif) as the iterations proceed. [Equation 2.2.2&#8211;1](02s02a15.md) is the basic quasi-Newton equation.

For convenience we define the change in the residual from one iteration to the next as

![](../graphics/stm_eqn00723.gif)so that [Equation 2.2.2&#8211;1](02s02a15.md) can be written
