...
This method creates a node set from an array of [OdbMeshNode](pt01ch34pyo18.md)                     objects (for part instance-level sets) or from a sequence of arrays of [OdbMeshNode](pt01ch34pyo18.md)                     objects (for assembly-level sets).
...
A sequence of [OdbMeshNode](pt01ch34pyo18.md)                              objects. For example, for a part:
...
This method creates an element set from an array of [OdbMeshElement](pt01ch34pyo17.md)                     objects (for part instance-level sets) or from a sequence of arrays of [OdbMeshElement](pt01ch34pyo17.md)                     objects (for assembly-level sets).
...
A sequence of [OdbMeshElement](pt01ch34pyo17.md)                              objects. For example, for a part:
...
A tuple of Strings specifying the namespaces for the nodes, elements, and faces; `None` if the set is on a Part or an [OdbInstance](pt01ch34pyo15.md)                     object.

*nodes*

An [OdbMeshNodeArray](pt01ch34pyo18.md) object specifying if a set spans more than one part instance, this member is a sequence of sequences for each part instance.

*elements*

An [OdbMeshElementArray](pt01ch34pyo17.md) object specifying if a set spans more than one part instance, this member is a sequence of sequences for each part instance.
