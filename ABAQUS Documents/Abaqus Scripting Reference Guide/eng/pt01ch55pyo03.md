...
The AreaStyle object is used to define how areas are to be filled when drawing XY-plot objects.
 ...
 AreaStyle objects are automatically created whenever an [Area](pt01ch55pyo02.md) object is created.  AreaStyle objects can be created using the methods described below. 
...
The AreaStyle object has members with the same names and descriptions as the arguments to the [setValues](pt01ch55pyo03.md#ker-areastyle-setvalues-pyc) method.
