...
The ButterworthFilter object is derived from the [Filter](pt02ch59pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [ButterworthFilter](pt02ch59pyo02.md#ker-butterworthfilter-butterworthfilter-cpp) method, except for the *name* argument.
...
The ButterworthFilter object has members with the same names and descriptions as the arguments to the [ButterworthFilter](pt02ch59pyo02.md#ker-butterworthfilter-butterworthfilter-cpp) method.

### 59.2.4 Corresponding analysis keywords
