...
The DisplacementAdaptiveMeshConstraintState object stores the propagating data for an Arbitrary Lagrangian Eularian (ALE) style displacement/rotation adaptive mesh constraint in a step. One instance of this object is created internally by the [DisplacementAdaptiveMeshConstraint](pt01ch02pyo07.md) object for each step. The instance is also deleted internally by the [DisplacementAdaptiveMeshConstraint](pt01ch02pyo07.md) object.

The DisplacementAdaptiveMeshConstraintState object has no constructor or methods.

The DisplacementAdaptiveMeshConstraintState object is derived from the [AdaptiveMeshConstraintState](pt01ch02pyo02.md) object.
...
| [*ADAPTIVE MESH CONSTRAINT](../key/key-link.md#usb-kws-hadaptivemeshconstraint), TYPE=DISPLACEMENT (degree of freedom: 1, 2, 3, 4, 5, or 6) |
| --- |
