...
The SurfaceCurrent object is derived from the [Load](pt01ch27pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [SurfaceCurrent](pt01ch27pyo66.md#ker-surfacecurrent-surfacecurrent-pyc) method, except for the *name* and *createStepName* arguments.
