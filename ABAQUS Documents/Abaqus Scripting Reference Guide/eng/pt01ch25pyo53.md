...
A Float specifying the ratio of the initial stiffness divided by the final stiffness.  This argument is valid only when *stiffnessBehavior*=NONLINEAR.  Possible values are 0 ![](../graphics/ker_eqn00013.gif) *stiffnessRatio* ![](../graphics/ker_eqn00048.gif) 1. The default value is 0.01.
...
A Float specifying the ratio of the overclosure at the initial stiffness divided by the overclosure at the maximum stiffness, both relative to the clearance at which the contact pressure is zero.  This argument is valid only when *stiffnessBehavior*=NONLINEAR.  Possible values are 0 ![](../graphics/ker_eqn00013.gif) *stiffnessRatio* ![](../graphics/ker_eqn00048.gif) 1. The default value is 0.33333.

**Table data**

If *pressureOverclosure*=EXPONENTIAL, the table data specify the following:
- Pressure at zero clearance, ![](../graphics/ker_eqn00079.gif).
- Clearance at which the contact pressure is zero, ![](../graphics/ker_eqn00080.gif).

If *pressureOverclosure*=TABULAR, the table data specify the following:- Pressure.
- Overclosure.
...
The optional arguments to `setValues` are the same as the arguments to the [NormalBehavior](pt01ch25pyo53.md#ker-normalbehavior-normalbehavior-pyc) method.
...
The NormalBehavior object has members with the same names and descriptions as the arguments to the [NormalBehavior](pt01ch25pyo53.md#ker-normalbehavior-normalbehavior-pyc) method.
