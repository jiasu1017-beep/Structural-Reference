...
The PorePressureBC object is derived from the [BoundaryCondition](pt01ch09pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [PorePressureBC](pt01ch09pyo36.md#ker-porepressurebc-porepressurebc-pyc) method, except for the *name* and *createStepName* arguments.
