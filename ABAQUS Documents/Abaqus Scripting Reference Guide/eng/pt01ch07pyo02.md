...
The CellArray is a sequence of [Cell](pt01ch07pyo01.md)                 objects.
...
This method returns the object or objects in the CellArray identified using the specified *mask*. This command is generated when the [JournalOptions](pt01ch47pyo06.md)                       are set to COMPRESSEDINDEX. When large number of objects are involved, this method is highly efficient.
...
A CellArray                       object, which is a sequence of [Cell](pt01ch07pyo01.md)                       objects.
