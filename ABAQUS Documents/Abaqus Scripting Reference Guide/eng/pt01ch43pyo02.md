...
The SymbolicConstant SIZE_ON_SCREEN or a pair of Floats specifying the width and height of the image in the units specified by *units*. Possible numeric values are *imageSize*                      ![](../graphics/ker_eqn00407.gif)                     (*minWidth*, *minHeight*).                    The default value is SIZE_ON_SCREEN.
...
The EpsOptions object has members with the same names and descriptions as the arguments to the [setValues](pt01ch43pyo02.md#ker-epsoptions-setvalues-pyc) method.
