...
We assume that the undeformed pipe is of circular or nearly circular section. Let ![](../graphics/stm_eqn05095.gif) be the material coordinates of a point in the pipe wall middle surface, defined as follows (see [Figure 3.9.1&#8211;1](03s09a92.md)).
