...
对于各向同性材料，![](../graphics/stm_eqn00579.gif) 仅为几何方便而选择，因此 ![](../graphics/graphics/stm_eqn00580.gif) 是相当通用的。

对于各向异性材料，材料基系统 ![](../graphics/graphics/stm_eqn00579.gif) 随材料的平均刚体旋转 ![](../graphics/stm_eqn00581.gif) 旋转，因此通过以下方式更新

![](../graphics/stm_eqn00582.gif)在这种情况下，我们看到

![](../graphics/stm_eqn00583.gif)因此，材料张量分量的更新简化为

![](../graphics/stm_eqn00584.gif)然而，由于在这种情况下材料基系统与单元基系统不相同，![](../graphics/graphics/stm_eqn00585.gif)（为单元计算的几何方便而选择），必须进行基系统变换。具体而言，在材料计算例程开始时，应变增量从单元基旋转到材料基：
