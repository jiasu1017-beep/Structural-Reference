...
A sequence of [MeshNode](pt01ch31pyo09.md) objects. The default value is `None`.

*elements*

A sequence of [MeshElement](pt01ch31pyo05.md) objects. The default value is `None`.
...
A [ReferencePointArray](pt01ch07pyo13.md) object.
