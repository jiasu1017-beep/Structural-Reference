...
![](../graphics/stm_eqn01831.gif)其中![](../graphics/stm_eqn01748)是液体的质量密度。
...
![](../graphics/stm_eqn01833.gif)其中![](../graphics/stm_eqn01834)是润湿液体相对于固相的平均速度（渗流速度），![](../graphics/stm_eqn00483)是*S*的外法线。
...
![](../graphics/stm_eqn01837.gif)其中![](../graphics/stm_eqn01838)是任意的、连续的变分场。这个陈述也可以写在参考体积上：
...
![](../graphics/stm_eqn01841.gif)我们现在通过采用约定 drop 下标![](../graphics/stm_eqn01842)，即任何未明确与时间点关联的量取在![](../graphics/stm_eqn01842)。

散度定理允许将方程重写为

![](../graphics/stm_eqn01843.gif)其中——为方便起见——我们通过参考配置中液体的密度![](../graphics/stm_eqn01777)对方程进行了归一化。

![](../graphics/stm_eqn01844.gif)由于![](../graphics/stm_eqn01844)，这与
...
![](../graphics/stm_eqn01847.gif)![](../graphics/stm_eqn01848.gif)![](../graphics/stm_eqn00155.gif)孔隙流体流动的本构行为由达西定律或Forchheimer定律控制。达西定律通常适用于低流体流速，而Forchheimer定律常用于涉及较高流速的情况。达西定律可以被认为是Forchheimer定律的线性化版本。达西定律指出，在均匀条件下，润湿液体通过介质单位面积的体积流率![](../graphics/stm_eqn01846)与测压水头梯度的负值成正比（[Bear，1972](07s01a01-References.md)）：

![](../graphics/stm_eqn01853.gif)![](../graphics/stm_eqn01854.gif)![](../graphics/stm_eqn01847.gif)其中![](../graphics/stm_eqn01848)是介质的渗透率，![](../graphics/stm_eqn00155)是测压水头，定义为
...
![](../graphics/stm_eqn01851.gif)![](../graphics/stm_eqn01852.gif)![](../graphics/stm_eqn01850.gif)其中![](../graphics/stm_eqn01851)是一个"速度系数"（[Tariq，1987](07s01a01-References.md)）。这个非线性渗透率可以定义为孔隙比的函数。我们看到，当流体速度趋于零时，Forchheimer定律趋近于达西定律。此外，如果![](../graphics/stm_eqn01852)，两种流动定律是相同的。

![](../graphics/stm_eqn01848.gif)![](../graphics/stm_eqn01853.gif)![](../graphics/stm_eqn01854.gif)![](../graphics/stm_eqn01848)可以是各向异性的，是饱和度和材料孔隙比的函数。![](../graphics/stm_eqn01848)具有速度单位（长度/时间）。[一些作者将![](../graphics/stm_eqn01848)称为水力传导率（[Bear，1972](07s01a01-References.md)），并将渗透率定义为

![](../graphics/stm_eqn01853.gif)其中![](../graphics/stm_eqn01854)是流体的运动粘度（流体动力粘度与其密度之比）。]

![](../graphics/stm_eqn01855.gif)![](../graphics/stm_eqn01856.gif)![](../graphics/stm_eqn01748.gif)我们假设*g*在大小和方向上是恒定的，所以

![](../graphics/stm_eqn01855.gif)其中![](../graphics/stm_eqn01856)是重力加速度（我们假设![](../graphics/stm_eqn01748)随位置缓慢变化）。
...
![](../graphics/stm_eqn01857.gif)其中![](../graphics/stm_eqn01858)提供了对饱和度的依赖性，![](../graphics/stm_eqn01859)和![](../graphics/stm_eqn01860)是完全饱和介质的渗透率。

![](../graphics/stm_eqn01861.gif)![](../graphics/stm_eqn01862.gif)![](../graphics/stm_eqn01863.gif)函数![](../graphics/stm_eqn01861)可以由用户定义。[Nguyen和Durso（1983）](07s01a01-References.md)观察到，在通过部分饱和介质的稳态流动中，渗透率随![](../graphics/stm_eqn01862)变化。因此，我们默认取![](../graphics/stm_eqn01863)。
...
由于![](../graphics/stm_eqn01719)测量润湿液体中的压力，而我们忽略介质中另一流体相中的压力（见"多孔介质的有效应力原理"第2.8.1节），当![](../graphics/stm_eqn01869)时，介质完全饱和。![](../graphics/stm_eqn01719)的负值表示介质中的毛细管效应。对于![](../graphics/stm_eqn01870)，已知（例如，见[Nguyen和Durso，1983](07s01a01-References.md)），在给定的毛细管压力值下，![](../graphics/stm_eqn01871)，饱和度在某个范围内。图2.8.4-1显示了这些范围的典型形式。
...
![](../graphics/stmliquid-absorp-exsorp-nls.png) 我们将这些范围写为![](../graphics/stm_eqn01872)，其中![](../graphics/stm_eqn01873)是发生吸收的限制（所以![](../graphics/stm_eqn01874)），![](../graphics/stm_eqn01875)是发生解吸的限制，因此![](../graphics/stm_eqn01876)。我们假设这些关系是唯一可逆的，因此也可以在吸收期间写为![](../graphics/stm_eqn01877)，在解吸期间写为![](../graphics/stm_eqn01878)。我们还假设一些润湿液体将始终存在于介质中：![](../graphics/stm_eqn01879)。

![](../graphics/stm_eqn01880.gif)[Bear（1972）](07s01a01-References.md)建议，吸收和解吸之间的转换以及相反过程沿"扫描"曲线进行。我们用直线近似这些，如图2.8.4-1所示。

![](../graphics/stm_eqn01881.gif)![](../graphics/stm_eqn01882.gif)![](../graphics/stm_eqn01883.gif)![](../graphics/stm_eqn01884.gif)饱和度被视为状态变量，如果润湿液体压力超出根据与图2.8.4-1对应的实际数据其值可接受的范围，则可能必须改变。饱和度作为状态变量的演化定义如下。假设时间*t*的饱和度![](../graphics/stm_eqn01880)是已知的。它必须满足约束

![](../graphics/stm_eqn01881.gif)我们求解连续性方程得到![](../graphics/stm_eqn01882)，最初假设![](../graphics/stm_eqn01883)。然后我们通过以下规则获得![](../graphics/stm_eqn01884)：

![](../graphics/stm_eqn01885.gif)其中![](../graphics/stm_eqn01886)是扫描线的斜率。这些选择如图2.8.4-2所示。
...
![](../graphics/stm_eqn01888.gif)![](../graphics/stm_eqn01719.gif)连续性方程的Jacobian贡献是从[方程2.8.4-2](02s08a39-Continuity-statement-for-the-wetting-liq.md)相对于![](../graphics/stm_eqn01887)和![](../graphics/stm_eqn01719)在时间![](../graphics/stm_eqn00438)的变分获得的。

首先考虑表面积分。表面分为液体质量流率![](../graphics/stm_eqn01888)被规定的那部分和润湿液体压力![](../graphics/stm_eqn01719)被规定的那部分。因此，这项对Jacobian的唯一贡献是由质量流率被规定的那部分表面积变化引起的积分变化。我们忽略这个贡献。
...
![](../graphics/stm_eqn01852.gif)[方程2.8.3-5](02s08a38-Constitutive-behavior-in-a-porous-medium.md)表明![](../graphics/stm_eqn01892)，它由"多孔介质中的本构行为"第2.8.3节中给出的演化方程定义，因此对Jacobian没有贡献。

![](../graphics/stm_eqn01893.gif)最后，渗透率项的Jacobian贡献在Forchheimer流动定律的一般情况下相当复杂。虽然我们在软件中包含了它，但这里我们只写反映达西定律（![](../graphics/stm_eqn01852)）的线性化流动版本：
