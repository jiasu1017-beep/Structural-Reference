...
The ConcentrationBC object is derived from the [BoundaryCondition](pt01ch09pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [ConcentrationBC](pt01ch09pyo09.md#ker-concentrationbc-concentrationbc-pyc) method, except for the *name* and *createStepName* arguments.
