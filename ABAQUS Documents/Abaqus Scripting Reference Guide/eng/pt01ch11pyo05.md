...
A Float specifying the translucency factor to use when displaying the image. Possible values are 0.0 ![](../graphics/ker_eqn00013.gif)                   *translucency*                   ![](../graphics/ker_eqn00013.gif)                  1.0 with 0.0 being invisible and 1.0 being opaque.                 The default value is 1.0.
...
The ImageOptions object has members with the same names and descriptions as the arguments to the [setValues](pt01ch11pyo05.md#ker-imageoptions-setvalues-pyc) method.
