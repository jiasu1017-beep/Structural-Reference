...
The EulerianBCState object stores the propagating data for an Eulerian boundary condition in a step. One instance of this object is created internally by the [EulerianBC](pt01ch09pyo23.md) object for each step. The instance is also deleted internally by the [EulerianBC](pt01ch09pyo23.md) object.

The EulerianBCState object has no constructor or methods.

The EulerianBCState object is derived from the [BoundaryConditionState](pt01ch09pyo08.md) object.
...
### 9.24.2 Corresponding analysis keywords
