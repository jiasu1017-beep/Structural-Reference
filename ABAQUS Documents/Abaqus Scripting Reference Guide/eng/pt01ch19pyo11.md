...
The PointFastener object is derived from the [Fastener](pt01ch19pyo07.md) object.
...
A [Region](pt01ch45pyo03.md) object specifying the region to which fasteners are applied.
...
A [VertexArray](pt01ch07pyo15.md) object of length 2 specifying the direction of projection. Instead of through a [Vertex](pt01ch07pyo15.md), each point may be specified through a tuple of coordinates. The default value is None.

*targetSurfaces*

A [RegionArray](pt01ch45pyo03.md) object specifying surfaces to be fastened. The default value is MODEL.
...
The optional arguments to `setValues` are the same as the arguments to the [PointFastener](pt01ch19pyo11.md#ker-pointfastener-pointfastener-pyc) method, except for the *name* argument.
...
The PointFastener object has members with the same names and descriptions as the arguments to the [PointFastener](pt01ch19pyo11.md#ker-pointfastener-pointfastener-pyc) method.
...
### 19.11.4 Corresponding analysis keywords
