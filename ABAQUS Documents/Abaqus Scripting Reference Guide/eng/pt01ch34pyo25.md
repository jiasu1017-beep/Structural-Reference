...
An [OdbSet](pt01ch34pyo23.md) object specifying a region for which the rebar orientation is defined.

*csys*

An [OdbDatumCsys](pt01ch34pyo13.md) object specifying a datum coordinates system.
