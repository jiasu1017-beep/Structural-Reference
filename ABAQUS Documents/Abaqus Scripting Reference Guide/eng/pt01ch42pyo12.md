# 42.12 PredefinedFieldState object
...
The PredefinedFieldState object is the base object for the objects in the `predefinedFieldState` repository of the [Step](pt01ch49pyo01.md) object. The members of the PredefinedFieldState object are common to all objects derived from PredefinedFieldState.
