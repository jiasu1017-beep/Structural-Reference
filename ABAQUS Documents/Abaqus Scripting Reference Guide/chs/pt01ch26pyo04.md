...
The ModelJob object defines a [Job](pt01ch26pyo01.md) object which analyzes a model on a model database (MDB).

The ModelJob object is derived from the [Job](pt01ch26pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [ModelJob](pt01ch26pyo04.md#ker-modeljob-job-pyc) method.
