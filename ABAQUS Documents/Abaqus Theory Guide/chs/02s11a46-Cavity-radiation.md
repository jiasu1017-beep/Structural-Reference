...
Abaqus/Standard提供了两种不同的方案来获得[方程2.11.4-1](02s11a46-Cavity-radiation.md)中定义的腔体辐射通量：一种稳健的串行方法，适用于小腔体；以及一种推荐用于大腔体的完全并行方法。腔体辐射方程的串行求解

涉及小腔体的热辐射问题允许我们求解[方程2.11.4-1](02s11a46-Cavity-radiation.md)得到进入腔体小平面每单位面积的辐射通量为
