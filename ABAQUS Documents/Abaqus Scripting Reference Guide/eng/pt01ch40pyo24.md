...
The ViewCutOptions object stores values and attributes associated with a view cut plot. The ViewCutOptions object has no constructor command. Abaqus creates a *defaultOdbDisplay.viewCutOptions* member when you import the Visualization module. Abaqus creates an *viewCutOptions* member when it creates the [OdbDisplay](pt01ch35pyo01.md) object, using the values from *defaultOdbDisplay.viewCutOptions*. Abaqus creates the *odbDisplay* member when a viewport is created, using the values from *defaultOdbDisplay*.
...
*belowOptions*
 ...
 `None` or an [OptionArg](pt01ch40pyo19.md) object specifying values to be used for defining the options applicable on the model below the cut. The default value is `None`.
...
*onOptions*
 ...
 `None` or an [OptionArg](pt01ch40pyo19.md) object specifying values to be used for defining the options applicable on the model on the cut. The default value is `None`.
...
*aboveOptions*
 ...
 `None` or an [OptionArg](pt01ch40pyo19.md) object specifying values to be used for defining the options applicable on the model above the cut. The default value is `None`.
