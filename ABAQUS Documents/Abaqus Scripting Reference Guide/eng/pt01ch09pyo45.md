...
The TypeBC object is derived from the [BoundaryCondition](pt01ch09pyo01.md) object.
...
This method always returns a value error for a TypeBC; it is inherited from the [BoundaryCondition](pt01ch09pyo01.md) object.
