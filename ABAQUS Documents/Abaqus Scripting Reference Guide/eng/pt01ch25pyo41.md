# 25.41 GapElectricalConductance object
...
The *pressureDepTable* data specify the following:- Conductivity.
- Pressure.
- Temperature, if the data depend on temperature.
- Value of the first field variable, if the data depend on field variables.
- Value of the second field variable.
...
The optional arguments to `setValues` are the same as the arguments to the [GapElectricalConductance](pt01ch25pyo41.md#ker-gapelectricalconductance-gapelectricalconductance-pyc) method.
...
The GapElectricalConductance object has members with the same names and descriptions as the arguments to the [GapElectricalConductance](pt01ch25pyo41.md#ker-gapelectricalconductance-gapelectricalconductance-pyc) method.
