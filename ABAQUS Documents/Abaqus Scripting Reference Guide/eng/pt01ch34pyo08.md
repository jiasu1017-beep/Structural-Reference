...
The HistoryOutput object has members with the same names and descriptions as the arguments to the [HistoryOutput](pt01ch34pyo08.md#ker-historyoutput-historyoutput-pyc) method.
