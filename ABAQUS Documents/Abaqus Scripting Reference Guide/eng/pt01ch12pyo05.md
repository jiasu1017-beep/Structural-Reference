# 12.5 ConnectorElasticity object
...
The ConnectorElasticity object is derived from the [ConnectorBehaviorOption](pt01ch12pyo01.md) object.
...
This method creates a connector elasticity behavior option for a [ConnectorSection](pt01ch46pyo08.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [ConnectorElasticity](pt01ch12pyo05.md#ker-connectorelasticity-connectorelasticity-pyc) method.
...
The ConnectorElasticity object has members with the same names and descriptions as the arguments to the [ConnectorElasticity](pt01ch12pyo05.md#ker-connectorelasticity-connectorelasticity-pyc) method.
...
### 12.5.4 Corresponding analysis keywords
