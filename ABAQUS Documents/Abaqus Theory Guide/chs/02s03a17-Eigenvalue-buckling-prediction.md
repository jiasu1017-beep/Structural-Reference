...
由于我们假设基态和当前状态是不可区分的，我们现在继续用Kirchhoff应力率 ![](../graphics/stm_eqn00785.gif)、速度梯度 ![](../graphics/stm_eqn00423.gif)、虚速度梯度 ![](../graphics/stm_eqn00786.gif) 和变形梯度 ![](../graphics/stm_eqn00319.gif) 表示左边。使用关系 ![](../graphics/stm_eqn00787.gif)，其中 ![](../graphics/stm_eqn00788.gif) 是以基态为参考配置的Kirchhoff应力，以及 ![](../graphics/stm_eqn00789.gif)，[方程 2.3.1-1](02s03a17-Eigenvalue-buckling-prediction.md) 取形式
...
对于 [方程 2.3.1-1](02s03a17-Eigenvalue-buckling-prediction.md) 的右边，我们注意到名义牵引 ![](../graphics/stm_eqn00156.gif) 和体力 ![](../graphics/stm_eqn00026.gif) 由 ![](../graphics/stm_eqn00795.gif) 和 ![](../graphics/stm_eqn00796.gif) 给出，其中 ![](../graphics/stm_eqn00797.gif) 和 ![](../graphics/stm_eqn00798.gif) 是当前配置中的表面积和体积元素。对于任何材料点，![](../graphics/stm_eqn00479.gif) 和 ![](../graphics/stm_eqn00178.gif) 在屈曲期间的变化完全由该点变形梯度的变化表征；粗略地说，施加力的大小在任何材料点保持固定，施加牵引力和体力强度的变化源于几何的变化。例如，对于压力荷载，压力大小保持不变但表面法线改变——这种变化完全由变形梯度的变化表征。由于参考配置和当前配置之间的表面积和体积度量的比值可以被视为仅是变形梯度 ![](../graphics/stm_eqn00319.gif) 的函数，因此 ![](../graphics/stm_eqn00156.gif) 和 ![](../graphics/stm_eqn00026.gif) 在任何给定材料点也仅通过它们对变形梯度的依赖而变化；因此，它们的变化率可以写成
...
![](../graphics/stm_eqn00810.gif)其中 ![](../graphics/stm_eqn00811.gif) 和 ![](../graphics/stm_eqn00812.gif) 是名义表面牵引和体力相对于节点位移的导数。由于我们不区分当前配置和参考配置，荷载刚度项中出现的偏导数都在 ![](../graphics/stm_eqn00813.gif) 处评估，对应于 ![](../graphics/stm_eqn00814.gif)。例如，出现在 [方程 2.3.1-2](02s03a17-Eigenvalue-buckling-prediction.md) 中的表面牵引的荷载刚度项，
...
![](../graphics/stm_eqn00818.gif)微分刚度由扰动应力引起的初始应力刚度和由扰动荷载引起的荷载刚度之和组成：
