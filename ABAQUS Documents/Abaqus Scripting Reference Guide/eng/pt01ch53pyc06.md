...
This function can be used to upgrade a directory, a file, or a list of both directories and files. You can preview the changes before you choose to upgrade the file. A user interface to this function is available via the Plug-ins menu. For more information, see ["Upgrading a script," Section 82.5 of the Abaqus/CAE User's Guide](../usi/usi-link.md#usi-plg-example-upgradescript). You can also use a simpler interface from the command line to upgrade scripts. For more information, see the summary of changed commands at the end of this guide.
...
A String specifying the Abaqus release from which to upgrade. The default value is `6.6`.

*toVersion*

A String specifying the Abaqus release to which to upgrade.  The default value is `6.12`. 
