...
The JobFromInputFile object defines a [Job](pt01ch26pyo01.md) object which analyzes a model contained in an input file.

The JobFromInputFile object is derived from the [Job](pt01ch26pyo01.md) object.
...
The optional arguments to `setValues` are the same as the arguments to the [JobFromInputFile](pt01ch26pyo02.md#ker-jobfrominputfile-jobfrominputfile-pyc) method, except for the *name* argument.
...
The JobFromInputFile object has members with the same names and descriptions as the arguments to the [JobFromInputFile](pt01ch26pyo02.md#ker-jobfrominputfile-jobfrominputfile-pyc) method.
