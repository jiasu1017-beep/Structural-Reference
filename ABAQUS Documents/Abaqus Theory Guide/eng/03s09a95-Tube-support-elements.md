...
The interface elements themselves consist of a spring and friction link and a dashpot, as shown in [Figure 3.9.4&#8211;3](03s09a95.md). The spring is assumed to behave as shown in [Figure 3.9.4&#8211;4](03s09a95.md): when there is no contact between the tube and the support, no force is transmitted by the spring; when the tube is in contact with the support, the force increases as the tube wall is deformed. This force can be modeled as a linear or a nonlinear function of the relative displacement between the axis of the tube and the center of the hole in the support.
